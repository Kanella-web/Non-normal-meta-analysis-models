...
write.csv(p[[4]]$true_eff , "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\Datasets application\\Simulated data application\\Normal_data\\true_eff\\true_eff_normal.csv",row.names=FALSE )  
...
### for the prediction intervals change the set.seed to set.seed(1234600)
...
RhatsN <- cbind.data.frame(mu_Normaljags.bin, LBmu.jags.bin, UBmu.jags.bin, tau2_Normaljags.bin,
 ...
 write.csv(RhatsN , "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\Datasets application\\Simulated data application\\Normal_data\\NORMAL\\res_Normal_data_Bayesian_Normal_model_HN.csv",row.names=FALSE )  
 write.csv(lista , "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\Datasets application\\Simulated data application\\Normal_data\\NORMAL\\rel_effN_Normal_data_Bayesian_Normal_model_HN.csv",row.names=FALSE )  
...
split_prob_list <- split_dataframe(prob_list, 26)  ### 26 = number of studies
...
write.csv(listaDP1 , "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\Datasets application\\Simulated data application\\Normal_data\\DP\\UGDP_rel_eff_Normal_data.csv",row.names=FALSE )  
write.csv(DPresults , "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\Datasets application\\Simulated data application\\Normal_data\\DP\\all_UGDP_res_Normal_data.csv",row.names=FALSE )  
write.csv(RhatsDP, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\Datasets application\\Simulated data application\\Normal_data\\DP\\UGDP_res_Normal_data.csv",row.names=FALSE )  
write.csv(prob , "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\Datasets application\\Simulated data application\\Normal_data\\DP\\UGDP_prob_Normal_data.csv",row.names=FALSE )  
write.csv( cluster_mean, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\Datasets application\\Simulated data application\\Normal_data\\DP\\UGDP_cluster_mean_Normal_data.csv",row.names=FALSE )  
...
filet_distr <- file.path(cmdstan_path(), "examples", "Stanmodels", "t_model_bin_HNpred.stan") ## OR t_model_bin_HN.stan
...
# write.csv(t_distr.res1 , "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\Datasets application\\Simulated data application\\Normal_data\\T\\pred_res_Normal_data_Bayesian_t_model_HN.csv",row.names=FALSE )  
# write.csv(deltat, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\Datasets application\\Simulated data application\\Normal_data\\T\\pred_rel_effT_Normal_data_Bayesian_t_model_HN.csv",row.names=FALSE )  
...
# write.csv(sn.res1 , "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\Datasets application\\Simulated data application\\Normal_data\\SN\\res_Normal_data_Bayesian_SN_model_HN.csv",row.names=FALSE )  
# write.csv(deltaSN, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\Datasets application\\Simulated data application\\Normal_data\\SN\\rel_effSN_Normal_data_Bayesian_SN_model_HN.csv",row.names=FALSE )  

write.csv(sn.res1 , "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\Datasets application\\Simulated data application\\Normal_data\\SN\\pred_res_Normal_data_Bayesian_SN_model_HN.csv",row.names=FALSE )  
write.csv(deltaSN, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\Datasets application\\Simulated data application\\Normal_data\\SN\\pred_rel_effSN_Normal_data_Bayesian_SN_model_HN.csv",row.names=FALSE )  
...
write.csv(n.res1 , "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\Datasets application\\Simulated data application\\Normal_data\\norm_stan\\res_Normal_data_Bayesian_N_model_HN.csv",row.names=FALSE )  
write.csv(deltaN, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\Datasets application\\Simulated data application\\Normal_data\\norm_stan\\rel_effN_Normal_data_Bayesian_N_model_HN.csv",row.names=FALSE )  
