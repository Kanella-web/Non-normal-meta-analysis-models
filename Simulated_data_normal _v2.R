...
write.csv(p[[4]]$true_eff , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Normal_data\\true_eff\\true_eff_normal.csv",row.names=FALSE )  
...
write.csv(RhatsNU , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Normal_data\\NORMAL\\res_Normal_data_Bayesian_Normal_model_Unif.csv",row.names=FALSE )  
write.csv(listaU , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Normal_data\\NORMAL\\rel_effN_Normal_data_Bayesian_Normal_model_Unif.csv",row.names=FALSE )  
...
write.csv(listaDP1 , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Normal_data\\DP\\UGDP_rel_eff_Normal_data.csv",row.names=FALSE )  
write.csv(DPresults , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Normal_data\\DP\\all_UGDP_res_Normal_data.csv",row.names=FALSE )  
write.csv(RhatsDP, "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Normal_data\\DP\\UGDP_res_Normal_data.csv",row.names=FALSE )  
write.csv(prob , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Normal_data\\DP\\UGDP_prob_Normal_data.csv",row.names=FALSE )  
write.csv( cluster_mean, "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Normal_data\\DP\\UGDP_cluster_mean_Normal_data.csv",row.names=FALSE )  
...
write.csv(t_distr.res_U1 , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Normal_data\\T\\pred_res_Normal_data_Bayesian_t_model_U.csv",row.names=FALSE )  
write.csv(deltat_U, "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Normal_data\\T\\pred_rel_effT_Normal_data_Bayesian_t_model_U.csv",row.names=FALSE )  
# 
# 
...
write.csv(sn.res_U1 , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Normal_data\\SN\\pred_res_Normal_data_Bayesian_SN_model_U.csv",row.names=FALSE )  
write.csv(deltaSN_U, "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Normal_data\\SN\\pred_rel_effSN_Normal_data_Bayesian_SN_model_U.csv",row.names=FALSE )  
