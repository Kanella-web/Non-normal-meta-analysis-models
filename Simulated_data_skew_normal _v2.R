...
write.csv(p[[1]]$true_eff , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_Normal_data\\true_eff\\true_eff_skew_normal.csv",row.names=FALSE )  
...
write.csv(RhatsN , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\NORMAL\\res_SN_data_Bayesian_NORMAL_HN_model.csv",row.names=FALSE )  
write.csv(lista , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\NORMAL\\rel_eff_SN_data_Bayesian_NORMAL_HN_model.csv",row.names=FALSE )  
...
write.csv(RhatsNU , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\NORMAL\\res_SN_data_Bayesian_NORMAL_U_model.csv",row.names=FALSE )  
write.csv(listaU , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\NORMAL\\rel_eff_SN_data_Bayesian_NORMAL_U_model.csv",row.names=FALSE )  
...
split_prob_list <- split_dataframe(prob_list, nrow(p[[1]]))
...
write.csv(listaDP1 , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\rel_eff_HN_U26_SN_data_Bayesian_DP_model.csv",row.names=FALSE )  
write.csv( DPresults, "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\res_all_HN_U26_SN_data_Bayesian_DP_model.csv",row.names=FALSE )  
write.csv( RhatsDP , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\res_HN_U26_SN_data_Bayesian_DP_model.csv",row.names=FALSE )  
write.csv( prob, "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\prob_HN_U26_res_SN_data_Bayesian_DP_model.csv",row.names=FALSE )  
write.csv( cluster_mean, "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\cluster_mean_HN_U26_res_SN_data_Bayesian_DP_model.csv",row.names=FALSE )  
...
cluster_mean_HN_U_51 = cbind.data.frame(mean_cl1_HN_U_51, mean_cl3_HN_U_51,mean_cl4_HN_U_51 )
...
write.csv(listaDP1_HN_U_51 , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\rel_eff_HN_U51_SN_data_Bayesian_DP_model.csv",row.names=FALSE )  
write.csv(DPresults_HN_U_51 , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\res_all_HN_U51_SN_data_Bayesian_DP_model.csv",row.names=FALSE )  
write.csv( RhatsDP_HN_U_51 , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\res_HN_U51_SN_data_Bayesian_DP_model.csv",row.names=FALSE )  
write.csv( prob_HN_U_51, "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\prob_HN_U51_res_SN_data_Bayesian_DP_model.csv",row.names=FALSE )  
write.csv( cluster_mean_HN_U_51, "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\cluster_mean_HN_U51_res_SN_data_Bayesian_DP_model.csv",row.names=FALSE )  
...
cluster_mean_U_U_26 = cbind.data.frame(mean_cl1_U_U_26, mean_cl2_U_U_26, mean_cl3_U_U_26 )
...
write.csv(listaDP1_U_U_26 , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\rel_eff_U_U26_SN_data_Bayesian_DP_model.csv",row.names=FALSE )  
write.csv(DPresults_U_U_26 , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\res_all_U_U26_SN_data_Bayesian_DP_model.csv",row.names=FALSE )  
write.csv( RhatsDP_U_U_26 , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\res_U_U26_SN_data_Bayesian_DP_model.csv",row.names=FALSE )  
write.csv( prob_U_U_26, "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\prob_U_U26_res_SN_data_Bayesian_DP_model.csv",row.names=FALSE )  
write.csv( cluster_mean_U_U_26, "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\cluster_mean_U_U26_res_SN_data_Bayesian_DP_model.csv",row.names=FALSE )  
...
cluster_meanU_U_51 = cbind.data.frame(mean_cl1U_U_51, mean_cl3U_U_51,mean_cl4U_U_51 )
...
write.csv(listaDP1U_U_51 , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\rel_eff_U_U51_SN_data_Bayesian_DP_model.csv",row.names=FALSE )  
write.csv(DPresultsU_U_51 , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\res_all_U_U51_SN_data_Bayesian_DP_model.csv",row.names=FALSE )  
write.csv( RhatsDPU_U_51 , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\res_U_U51_SN_data_Bayesian_DP_model.csv",row.names=FALSE )  
write.csv(probU_U_51, "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\prob_U_U51_res_SN_data_Bayesian_DP_model.csv",row.names=FALSE )  
write.csv( cluster_meanU_U_51, "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\cluster_mean_U_U51_res_SN_data_Bayesian_DP_model.csv",row.names=FALSE )  
...
DPresults_UGn <- as.data.frame( run.modelDP_UGn$BUGSoutput$summary) 


Pr_mu_UGn = mean(run.modelDP_UGn$BUGSoutput$sims.matrix[  ,"poptrue"] < 0 )


DP_results_UGn <-DPresults_UGn


DPresults_UGn$ind <- row.names(DPresults_UGn)

############# extraction of the parameters of interest ###########

f55sc <- grepl("SC", row.names(DPresults_UGn))
m55sc <- DPresults_UGn[f55sc,]
SC <- m55sc$mean
...
cluster1_UGn = positions[["1"]]
cluster2_UGn = positions[["2"]] 


f11 <- grepl("poptrue", row.names(DP_results_UGn))
m11 <- DP_results_UGn[f11,]
mu_DP_UGn<- m11$`50%`
LB_mu_DP_UGn <- m11$`2.5%`
UB_mu_DP_UGn <- m11$`97.5%`
Rhat_muDP_UGn <- m11$Rhat
precDP_mu_UGn <- UB_mu_DP_UGn - LB_mu_DP_UGn

f22 <- grepl("var.true", row.names(DP_results_UGn))
m22 <- DP_results_UGn[f22,]
tau2_DP_UGn <- m22$`50%`
LB_tau2_DP_UGn <- m22$`2.5%`
UB_tau2_DP_UGn <- m22$`97.5%`
Rhat_tauDP_UGn <- m22$Rhat
precDP_tau2_UGn <- UB_tau2_DP_UGn -  LB_tau2_DP_UGn

tau_DP_UGn <-sqrt(tau2_DP_UGn)
LB_tau_DP_UGn <- sqrt(LB_tau2_DP_UGn)
UB_tau_DP_UGn <- sqrt(UB_tau2_DP_UGn)
precDP_tau_UGn <- UB_tau_DP_UGn -  LB_tau_DP_UGn


fdd <- grepl("delta12", row.names(DP_results_UGn))
mdd <- DP_results_UGn[fdd,]
rel_effDP_UGn <- mdd$`50%`
LB_rel_effDP_UGn <- mdd$`2.5%`
UB_rel_effDP_UGn <- mdd$`97.5%`
sd_rel_effDP_UGn <- mdd$sd
Rhat_deltaDP_UGn <- mdd$Rhat

#### Mean of each cluster ######
cl1_UGn = rel_effDP_UGn[cluster1_UGn]
mean_cl1_UGn = mean(cl1_UGn)
cl2_UGn = rel_effDP_UGn[cluster2_UGn]
mean_cl2_UGn = mean(cl2_UGn)

cluster_mean_UGn = cbind.data.frame(mean_cl1_UGn, mean_cl2_UGn )


f33 <- grepl("basemu", row.names(DP_results_UGn))
m33 <- DP_results_UGn[f33,]
base_mu_UGn <- m33$`50%`
LB_base_mu_UGn <- m33$`2.5%`
UB_base_mu_UGn <- m33$`97.5%`
Rhat_basemu_UGn <- m33$Rhat
prec_basemu_UGn <- UB_base_mu_UGn - LB_base_mu_UGn

f44 <- grepl("basetau", row.names(DP_results_UGn))
m44 <- DP_results_UGn[f44,]
base_tau_UGn <- m44$`50%`
base_tau2_UGn <- (m44$`50%`)^2
LB_base_tau2_UGn <- (m44$`2.5%`)^2
UB_base_tau2_UGn <- (m44$`97.5%`)^2
Rhat_basetau_UGn <- (m44$Rhat)^2
prec_basetau2_UGn <- UB_base_tau2_UGn - LB_base_tau2_UGn

f55 <- grepl("alpha", row.names(DP_results_UGn))
m55 <- DP_results_UGn[f55,]
alpha_UGn <- m55$`50%`
LB_alpha_UGn <- m55$`2.5%`
UB_alpha_UGn <- m55$`97.5%`
Rhat_alpha_UGn <- m55$Rhat
prec_alpha_UGn <- UB_alpha_UGn - LB_alpha_UGn

fcl <- grepl("K", row.names(DP_results_UGn))   
mcl <- DP_results_UGn[fcl,]
median_K_UGn <- mcl$`50%` 
LB_K_UGn <- mcl$`2.5%`
UB_K_UGn <- mcl$`97.5%`

fp <- grepl("p", row.names(DP_results_UGn))
mp <- DP_results_UGn[fp,]
mp <- mp[!grepl("pop", row.names(mp)),]
mp <- mp[!grepl("alpha", row.names(mp)),]
pi_UGn <- mp$mean


listaDP1_UGn <- cbind.data.frame(rel_effDP_UGn,sd_rel_effDP_UGn, LB_rel_effDP_UGn,UB_rel_effDP_UGn,Rhat_deltaDP_UGn)


numclus_UGn <- unlist(median_K_UGn)
LB_K_UGn <- unlist(LB_K_UGn)
UB_K_UGn <- unlist(UB_K_UGn)

RhatsDP_UGn <- cbind.data.frame(base_mu_UGn,LB_base_mu_UGn,UB_base_mu_UGn,
                                base_tau_UGn,base_tau2_UGn, LB_base_tau2_UGn,UB_base_tau2_UGn,
                                mu_DP_UGn, LB_mu_DP_UGn, UB_mu_DP_UGn, tau2_DP_UGn, LB_tau2_DP_UGn, UB_tau2_DP_UGn,
                                tau_DP_UGn, LB_tau_DP_UGn, UB_tau_DP_UGn,
                                precDP_mu_UGn, precDP_tau2_UGn,precDP_tau_UGn,
                                prec_basemu_UGn, prec_basetau2_UGn,
                                prec_alpha_UGn,  alpha_UGn , LB_alpha_UGn, UB_alpha_UGn,
                                Rhat_muDP_UGn, Rhat_tauDP_UGn, Rhat_basemu_UGn, Rhat_basetau_UGn, 
                                Rhat_alpha_UGn, numclus_UGn, LB_K_UGn, UB_K_UGn, Pr_mu_UGn)

extra_col_UGn = row.names(DP_results_UGn)
DPresults_UGn$extra_col = extra_col_UGn
prob_UGn = round(max_values,2)

write.csv(listaDP1_UGn , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\rel_eff_UGn_SN_data_Bayesian_DP_model.csv",row.names=FALSE )  
write.csv(DPresults_UGn , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\res_all_UGn_SN_data_Bayesian_DP_model.csv",row.names=FALSE )  
write.csv( RhatsDP_UGn, "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\res_UGn_SN_data_Bayesian_DP_model.csv",row.names=FALSE )  
write.csv(prob_UGn, "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\prob_UGn_res_SN_data_Bayesian_DP_model.csv",row.names=FALSE )  
write.csv(cluster_mean_UGn , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\cluster_mean_UGn_res_SN_data_Bayesian_DP_model.csv",row.names=FALSE )  
...
write.csv(t_distr.res1 , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\T\\pred_SN_data_Bayesian_T_model_U.csv",row.names=FALSE )  
write.csv(deltat , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\T\\pred_rel_effT_SN_data_Bayesian_T_model_U.csv",row.names=FALSE )  
...
filet_distr_HN <- file.path(cmdstan_path(), "examples", "Stanmodels", "t_model_bin_HNpred.stan") 

modt_distr_HN <- cmdstan_model(filet_distr_HN)

fitt_distr_HN <- modt_distr_HN$sample(
  data = list(ns = nrow(p[[1]]),
              r1 = p[[1]]$ci,
              r2 = p[[1]]$ti,
              n1 = p[[1]]$nci,
...
t_distr.res_HN <- as.data.frame(fitt_distr_HN$summary())

#### To visualize the predictive distribution
bayesplot::color_scheme_set("brightblue")
bayesplot::mcmc_dens(fitt_distr_HN$draws(c("mu", "pred")))

### Pr of mu <- 0
Pr_mu_HN = mean(fitt_distr_HN$draws("mu") < 0 )

### Pr of pred1 <- 0
Pr_pred_HN = mean(fitt_distr_HN$draws("pred") < 0 )


d_HN <- grepl("delta",t_distr.res_HN$variable)

deltat_HN <- t_distr.res_HN[d_HN,]


dm_HN <- grepl("mu",t_distr.res_HN$variable)

median_HN <- t_distr.res_HN[dm_HN,]$median
LBmu_HN <- t_distr.res_HN[dm_HN,]$q5
UBmu_HN <- t_distr.res_HN[dm_HN,]$q95
Rhat_mut_distr_HN <-  t_distr.res_HN[dm_HN,]$rhat


ddn_HN <- grepl("pred",t_distr.res_HN$variable)

delta_new_HN <- t_distr.res_HN[ddn_HN,]$median
LBdelta_new_HN <- t_distr.res_HN[ddn_HN,]$q5
UBdelta_new_HN <- t_distr.res_HN[ddn_HN,]$q95
Rhat_delta_newt_distr_HN <-  t_distr.res_HN[ddn_HN,]$rhat

tau2_HN <- c()
dtau2_HN <- grepl("tau_sqr",t_distr.res_HN$variable)

tau2_HN <- t_distr.res_HN[dtau2_HN,]$median
LBtau2_HN <- t_distr.res_HN[dtau2_HN,]$q5
UBtau2_HN <- t_distr.res_HN[dtau2_HN,]$q95
Rhat_tau2t_distr_HN <- t_distr.res_HN[dtau2_HN,]$rhat

tau_HN <- sqrt(t_distr.res_HN[dtau2_HN,]$median)
LBtau_HN <- sqrt(t_distr.res_HN[dtau2_HN,]$q5)
UBtau_HN <- sqrt(t_distr.res_HN[dtau2_HN,]$q95)

t_distr.res_HN1<-data.frame(median=median_HN, 
                            lowerCI=LBmu_HN,
                            upperCI=UBmu_HN,
                            tau2=tau2_HN,
                            l_tau2 = LBtau2_HN,
                            ...
                            l_tau = LBtau_HN,
                            u_tau = UBtau_HN,
                            Rhat_mut_distr = Rhat_mut_distr_HN,
                            Rhat_tau2t_distr = Rhat_tau2t_distr_HN,
                            delta_new = delta_new_HN,
                            LBdelta_new = LBdelta_new_HN,
                            UBdelta_new = UBdelta_new_HN,
                            Rhat_delta_newt_distr = Rhat_delta_newt_distr_HN,
                            Pr_mu = Pr_mu_HN,
                            Pr_pred = Pr_pred_HN
)


write.csv(t_distr.res_HN1 , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\T\\pred_SN_data_Bayesian_T_model_HN.csv",row.names=FALSE )  
write.csv(deltat_HN , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\T\\pred_rel_effT_SN_data_Bayesian_T_model_HN.csv",row.names=FALSE )  
...
write.csv(sn.res1 , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\SN\\pred_SN_data_Bayesian_SN_model_U.csv",row.names=FALSE )  
write.csv(deltaSN , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\SN\\pred_rel_effSN_SN_data_Bayesian_SN_model_U.csv",row.names=FALSE )  
...
fileSN_HN <- file.path(cmdstan_path(), "examples", "Stanmodels", "Skew_normal_model_bin_HNpred.stan")
modSN_HN <- cmdstan_model(fileSN_HN)

fitSN_HN <- modSN_HN$sample(
  data =list(ns = nrow(p[[1]]),
             r1 = p[[1]]$ci,
             r2 = p[[1]]$ti,
             n1 = p[[1]]$nci,
...
sn.res_HN <- as.data.frame(fitSN_HN$summary())

#### To visualize the predictive distribution
bayesplot::color_scheme_set("brightblue")
bayesplot::mcmc_dens(fitSN_HN$draws(c("mu", "pred1")))

### Pr of mu <- 0
Pr_mu_HN = mean(fitSN_HN$draws("mu") < 0 )

### Pr of pred1 <- 0
Pr_pred_HN = mean(fitSN_HN$draws("pred1") < 0 )


d_HN <- grepl("delta",sn.res_HN$variable)

deltaSN_HN <- sn.res_HN[d_HN,]


dm_HN <- grepl("mu",sn.res_HN$variable)

median_HN <- sn.res_HN[dm_HN,]$median
LBmu_HN <- sn.res_HN[dm_HN,]$q5
UBmu_HN <- sn.res_HN[dm_HN,]$q95
Rhat_muSN_HN <-  sn.res_HN[dm_HN,]$rhat


dtau2_HN <- grepl("tau_sqr",sn.res_HN$variable)

tau2_HN <- sn.res_HN[dtau2_HN,]$median
LBtau2_HN <- sn.res_HN[dtau2_HN,]$q5
UBtau2_HN <- sn.res_HN[dtau2_HN,]$q95
Rhat_tau2SN_HN <- sn.res_HN[dtau2_HN,]$rhat

tau_HN <- sqrt(sn.res_HN[dtau2_HN,]$median)
LBtau_HN <- sqrt(sn.res_HN[dtau2_HN,]$q5)
UBtau_HN <- sqrt(sn.res_HN[dtau2_HN,]$q95)
Rhat_tauSN_HN <- sqrt(sn.res_HN[dtau2_HN,]$rhat)

dx_HN <- grepl("xi",sn.res_HN$variable)

xi_HN <- sn.res_HN[dx_HN, ]$median
LBxi_HN <- sn.res_HN[dx_HN,]$q5
UBxi_HN <- sn.res_HN[dx_HN,]$q95
Rhat_SN_HN <-  sn.res_HN[dx_HN,]$rhat

dxn_HN <- grepl("pred1",sn.res_HN$variable)
pred_HN <- sn.res_HN[dxn_HN,]$median
LBpred_HN <- sn.res_HN[dxn_HN,]$q5
UBpred_HN <- sn.res_HN[dxn_HN,]$q95
Rhat_predSN_HN <-  sn.res_HN[dxn_HN,]$rhat

skew_HN <- c()
dskew_HN <- grepl("skew",sn.res_HN$variable)

skew_HN <- sn.res_HN[dskew_HN,]$median
LBskew_HN <- sn.res_HN[dskew_HN,]$q5
UBskew_HN <- sn.res_HN[dskew_HN,]$q95
Rhat_skewSN_HN <- sn.res_HN[dskew_HN,]$rhat

sn.res_HN1<-data.frame(median=median_HN, 
                       lowerCI=LBmu_HN,
                       upperCI=UBmu_HN,
                       tau2=tau2_HN,
                       l_tau2 = LBtau2_HN,
                       ...
                       l_skew = LBskew_HN,
                       u_skew = UBskew_HN,
                       Rhat_muSN = Rhat_muSN_HN,
                       Rhat_tau2SN = Rhat_tau2SN_HN,
                       Rhat_skewSN = Rhat_skewSN_HN,
                       pred = pred_HN,
                       LBpred = LBpred_HN,
                       UBpred = UBpred_HN,
                       Rhat_predSN = Rhat_predSN_HN,
                       Pr_mu = Pr_mu_HN,
                       Pr_pred1 = Pr_pred_HN
)


write.csv(sn.res_HN1 , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\SN\\pred_SN_data_Bayesian_SN_model_HN.csv",row.names=FALSE )  
write.csv(deltaSN_HN , "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\SN\\pred_rel_effSN_SN_data_Bayesian_SN_model_HN.csv",row.names=FALSE )  
...
freq_norm1bin <- rma.glmm(measure = "OR",
                          ai = p[[1]]$ti, bi = p[[1]]$nti - p[[1]]$ti,
                          ci = p[[1]]$ci, di = p[[1]]$nci - p[[1]]$ci,
                          data = p[[1]],  model="UM.RS")

freq_normbin <- summary(freq_norm1bin)

mu_fr_norm.bin <- freq_normbin$beta
...
tau2_fr_norm.bin <- freq_normbin$tau2
tau_fr_norm.bin <- sqrt(freq_normbin$tau2)
...
write.csv(fr_normal.bin, "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\norm_fr_bin\\Results_freq_Normal_bin_model_SN_data.csv",row.names=FALSE )  
...
write.csv(stud_eff ,   "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\norm_fr\\Rel_eff_freq_Normal_normal_model_SN_data.csv",row.names=FALSE )  
...
write.csv(fr_normal, "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\norm_fr\\Results_freq_Normal_normal_model_SN_data.csv",row.names=FALSE )  
...
dat1 = escalc(measure="OR",ai = p[[1]]$ti, bi =p[[1]]$nti - p[[1]]$ti,
              ci =p[[1]]$ci, di = p[[1]]$nci - p[[1]]$ci,
              data = p[[1]])
...
write.csv(metaplus_t, "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\METAPLUS_T\\Results_metaplust_SN_data.csv",row.names=FALSE )  
...
write.csv(metaplus_mix, "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\METAPLUS_MIXTURE\\Results_metaplust_SN_data.csv",row.names=FALSE )  


############### SAVE THE RESULTS ############

NHN = read.csv( "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\NORMAL\\res_SN_data_Bayesian_NORMAL_HN_model.csv")  
NU = read.csv( "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\NORMAL\\res_SN_data_Bayesian_NORMAL_U_model.csv")  
DP_UGn = read.csv(  "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\res_UGn_SN_data_Bayesian_DP_model.csv")  
DP_26_HN_U = read.csv(  "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\res_HN_U26_SN_data_Bayesian_DP_model.csv" )  
DP_HN_U_51 = read.csv( "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\res_HN_U51_SN_data_Bayesian_DP_model.csv")  
DP_U_U_26 = read.csv( "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\res_U_U26_SN_data_Bayesian_DP_model.csv" )  
DPU_U_51 = read.csv( "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\DP\\res_U_U51_SN_data_Bayesian_DP_model.csv" )  
t_distrHN = read.csv( "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\T\\pred_SN_data_Bayesian_T_model_HN.csv")  
t_distrU = read.csv( "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\T\\pred_SN_data_Bayesian_T_model_U.csv" )  
SNHN =read.csv("C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\SN\\pred_SN_data_Bayesian_SN_model_HN.csv" )  
SNU = read.csv( "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\SN\\pred_SN_data_Bayesian_SN_model_U.csv" )  
fr_normal.bin = read.csv( "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\norm_fr_bin\\Results_freq_Normal_bin_model_SN_data.csv" )  
fr_normal = read.csv( "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\norm_fr\\Results_freq_Normal_normal_model_SN_data.csv" )  
metaplus_t = read.csv( "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\METAPLUS_T\\Results_metaplust_SN_data.csv" )  
metaplus_mix = read.csv( "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\METAPLUS_MIXTURE\\Results_metaplust_SN_data.csv")  
...
write.csv(matrix, "C:\\Users\\kanel\\OneDrive\\Υπολογιστής\\Simulated data application\\Skew_normal_data\\Results_matrix_SN_data.csv",row.names=FALSE )  
