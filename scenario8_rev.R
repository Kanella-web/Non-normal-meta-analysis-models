############################# Scenario 8:Normal data k=26, mu=0.5, tau2=2.63 ######################
...
######################## AVERAGE DIFFERENCES OF RELATIVE EFFECTS ##################
rel_bias_relNU <- list()
...
write.csv(Norm_bin_jagsU, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\NORMAL MODEL\\rev_UNIF_ResultsNormal_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
write.csv(listaNormU, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\NORMAL MODEL\\rev_UNIF_Relative_eff_ResultsNormal_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
write.csv(lista_rel_effU, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\NORMAL MODEL\\rev_UNIF_Bias_Relative_eff_ResultsNormal_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
write.csv(Overalp_NormalU, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\NORMAL MODEL\\rev_UNIF_Overalp_Normal_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
...
write.csv(Norm_bin_jagsHN, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\NORMAL MODEL\\rev_HN_ResultsNormal_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
write.csv(listaNormHN, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\NORMAL MODEL\\rev_HN_Relative_eff_ResultsNormal_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
write.csv(lista_rel_effHN, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\NORMAL MODEL\\rev_HN_Bias_Relative_eff_ResultsNormal_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
write.csv(Overalp_NormalHN, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\NORMAL MODEL\\rev_HN_Overalp_Normal_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
# 
...
cl = makeCluster(19)
registerDoParallel(cl)
DPresults1HN_U_26 <- list()

DPresults1HN_U_26 = foreach(i = 1:N.sim,.packages = c("rjags", "R2jags","tidyverse")) %dopar% {
  set.seed(273)
  run.model = jags(
...
DPresultsHN_U_26 <- list()
posteriorDPHN_U_26 <- list()
postDPHN_U_26 <- list()
for(i in 1:N.sim){
  DPresultsHN_U_26[[i]] <- as.data.frame(DPresults1HN_U_26[[i]]$BUGSoutput$summary) 
  posteriorDPHN_U_26[[i]] = as.data.frame(DPresults1HN_U_26[[i]]$BUGSoutput$sims.matrix)
  postDPHN_U_26[[i]] <- posteriorDPHN_U_26[[i]]$poptrue
}

DP_resultsHN_U_26 <- list()
for(i in 1:N.sim){
  DP_resultsHN_U_26[[i]] <- DPresultsHN_U_26[[i]] 
}
...
UB_tau2_DPHN_U_26 <- c()
precDP_muHN_U_26 <- c()
precDP_tau2HN_U_26 <- c()
prec_basemuHN_U_26 <- c()
prec_basetau2HN_U_26 <- c()
prec_alphaHN_U_26 <- c()
base_muHN_U_26 <- c()
base_tauHN_U_26 <- c()
base_tau2HN_U_26 <- c()
LB_base_muHN_U_26 <- c()
UB_base_muHN_U_26 <- c()
LB_base_tau2HN_U_26 <- c()
UB_base_tau2HN_U_26 <- c()
Rhat_muDPHN_U_26 <- c()
Rhat_tau2DPHN_U_26 <- c()
Rhat_basemuHN_U_26 <- c()
Rhat_basetauHN_U_26 <- c()
Rhat_alphaHN_U_26 <- c()
Rhat_deltaDPHN_U_26 <- list()
median_KHN_U_26 <- list()
LB_KHN_U_26 <- list()
UB_KHN_U_26 <- list()
rel_effDPHN_U_26 <- list()
LB_rel_effDPHN_U_26 <- list()
UB_rel_effDPHN_U_26 <- list()
sd_rel_effDPHN_U_26 <- list()
piHN_U_26 <- list()
f11HN_U_26 <- list()
m11HN_U_26 <- list()
f22HN_U_26 <- list()
...
fpHN_U_26 <- list()
mpHN_U_26 <- list()
listaDP1HN_U_26 <- list()
listaDP_weightsHN_U_26 <- list()
for(i in 1:N.sim){
  f11HN_U_26[[i]] <- grepl("poptrue", row.names(DP_resultsHN_U_26[[i]]))
  m11HN_U_26[[i]] <- DP_resultsHN_U_26[[i]][f11HN_U_26[[i]],]
  mu_DPHN_U_26[i] <- m11HN_U_26[[i]]$`50%`
  LB_mu_DPHN_U_26[i] <- m11HN_U_26[[i]]$`2.5%`
  UB_mu_DPHN_U_26[i] <- m11HN_U_26[[i]]$`97.5%`
  Rhat_muDPHN_U_26[i] <- m11HN_U_26[[i]]$Rhat
  precDP_muHN_U_26[i] <- UB_mu_DPHN_U_26[i] - LB_mu_DPHN_U_26[i]
  
  f22HN_U_26[[i]] <- grepl("var.true", row.names(DP_resultsHN_U_26[[i]]))
  m22HN_U_26[[i]] <- DP_resultsHN_U_26[[i]][f22HN_U_26[[i]],]
  tau2_DPHN_U_26[i] <- m22HN_U_26[[i]]$`50%`
  LB_tau2_DPHN_U_26[i] <- m22HN_U_26[[i]]$`2.5%`
  UB_tau2_DPHN_U_26[i] <- m22HN_U_26[[i]]$`97.5%`
  Rhat_tau2DPHN_U_26[i] <- m22HN_U_26[[i]]$Rhat
  precDP_tau2HN_U_26[i] <- UB_tau2_DPHN_U_26[i] -  LB_tau2_DPHN_U_26[i]
  
  fddHN_U_26[[i]] <- grepl("delta12", row.names(DP_resultsHN_U_26[[i]]))
  mddHN_U_26[[i]] <- DP_resultsHN_U_26[[i]][fddHN_U_26[[i]],]
  rel_effDPHN_U_26[[i]] <- mddHN_U_26[[i]]$`50%`
  LB_rel_effDPHN_U_26[[i]] <- mddHN_U_26[[i]]$`2.5%`
  UB_rel_effDPHN_U_26[[i]] <- mddHN_U_26[[i]]$`97.5%`
  sd_rel_effDPHN_U_26[[i]] <- mddHN_U_26[[i]]$sd
  Rhat_deltaDPHN_U_26[[i]] <- mddHN_U_26[[i]]$Rhat
  
  f33HN_U_26[[i]] <- grepl("basemu", row.names(DP_resultsHN_U_26[[i]]))
  m33HN_U_26[[i]] <- DP_resultsHN_U_26[[i]][f33HN_U_26[[i]],]
  base_muHN_U_26[i] <- m33HN_U_26[[i]]$`50%`
  LB_base_muHN_U_26[i] <- m33HN_U_26[[i]]$`2.5%`
  UB_base_muHN_U_26[i] <- m33HN_U_26[[i]]$`97.5%`
  Rhat_basemuHN_U_26[i] <- m33HN_U_26[[i]]$Rhat
  prec_basemuHN_U_26[i] <- UB_base_muHN_U_26[i] - LB_base_muHN_U_26[i]
  
  f44HN_U_26[[i]] <- grepl("basetau", row.names(DP_resultsHN_U_26[[i]]))
  m44HN_U_26[[i]] <- DP_resultsHN_U_26[[i]][f44HN_U_26[[i]],]
  base_tauHN_U_26[i] <- m44HN_U_26[[i]]$`50%`
  base_tau2HN_U_26[i] <- (m44HN_U_26[[i]]$`50%`)^2
  LB_base_tau2HN_U_26[i] <- (m44HN_U_26[[i]]$`2.5%`)^2
  UB_base_tau2HN_U_26[i] <- (m44HN_U_26[[i]]$`97.5%`)^2
  Rhat_basetauHN_U_26[i] <- (m44HN_U_26[[i]]$Rhat)^2
  prec_basetau2HN_U_26[i] <- UB_base_tau2HN_U_26[i] - LB_base_tau2HN_U_26[i]
  
  f55HN_U_26[[i]] <- grepl("alpha", row.names(DP_resultsHN_U_26[[i]]))
  m55HN_U_26[[i]] <- DP_resultsHN_U_26[[i]][f55HN_U_26[[i]],]
  alphaHN_U_26[i] <- m55HN_U_26[[i]]$`50%`
  LB_alphaHN_U_26[i] <- m55HN_U_26[[i]]$`2.5%`
  UB_alphaHN_U_26[i] <- m55HN_U_26[[i]]$`97.5%`
  Rhat_alphaHN_U_26[i] <- m55HN_U_26[[i]]$Rhat
  prec_alphaHN_U_26[i] <- UB_alphaHN_U_26[i] - LB_alphaHN_U_26[i]
  
  fclHN_U_26[[i]] <- grepl("K", row.names(DP_resultsHN_U_26[[i]]))  
  mclHN_U_26[[i]] <- DP_resultsHN_U_26[[i]][fclHN_U_26[[i]],]
  median_KHN_U_26[[i]] <- mclHN_U_26[[i]]$`50%` 
  LB_KHN_U_26[[i]] <- mclHN_U_26[[i]]$`2.5%`
  UB_KHN_U_26[[i]] <- mclHN_U_26[[i]]$`97.5%`
  
  fpHN_U_26[[i]] <- grepl("p", row.names(DP_resultsHN_U_26[[i]]))
  mpHN_U_26[[i]] <- DP_resultsHN_U_26[[i]][fpHN_U_26[[i]],]
  mpHN_U_26[[i]] <- mpHN_U_26[[i]][!grepl("pop", row.names(mpHN_U_26[[i]])),]
  mpHN_U_26[[i]] <- mpHN_U_26[[i]][!grepl("alpha", row.names(mpHN_U_26[[i]])),]
  piHN_U_26[[i]] <- mpHN_U_26[[i]]$mean
  
  listaDP1HN_U_26[[i]] <- cbind.data.frame(rel_effDPHN_U_26[[i]],sd_rel_effDPHN_U_26[[i]], LB_rel_effDPHN_U_26[[i]],UB_rel_effDPHN_U_26[[i]],Rhat_deltaDPHN_U_26[[i]])
  listaDP_weightsHN_U_26[[i]] <- cbind.data.frame(piHN_U_26[[i]])
  
}

numclusHN_U_26 <- unlist(median_KHN_U_26)
LB_KHN_U_26 <- unlist(LB_KHN_U_26)
UB_KHN_U_26 <- unlist(UB_KHN_U_26)

mean_alphaHN_U_26 = mean(alphaHN_U_26)
mean_alpha_LBHN_U_26 = mean(LB_alphaHN_U_26)
mean_alpha_UBHN_U_26 = mean(UB_alphaHN_U_26)

tau_DPHN_U_26 = sqrt(tau2_DPHN_U_26)
LB_tau_DPHN_U_26 = sqrt(LB_tau2_DPHN_U_26)
UB_tau_DPHN_U_26 = sqrt(UB_tau2_DPHN_U_26)
precDP_tauHN_U_26 = UB_tau_DPHN_U_26 -  LB_tau_DPHN_U_26


RhatsDPHN_U_26 <- cbind.data.frame(base_muHN_U_26,LB_base_muHN_U_26,UB_base_muHN_U_26,base_tauHN_U_26,base_tau2HN_U_26, LB_base_tau2HN_U_26,UB_base_tau2HN_U_26,
                                   mu_DPHN_U_26, LB_mu_DPHN_U_26, UB_mu_DPHN_U_26, tau2_DPHN_U_26, LB_tau2_DPHN_U_26, UB_tau2_DPHN_U_26,
                                   tau_DPHN_U_26, LB_tau_DPHN_U_26, UB_tau_DPHN_U_26,
                                   precDP_muHN_U_26, precDP_tau2HN_U_26, prec_basemuHN_U_26, prec_basetau2HN_U_26,prec_alphaHN_U_26,  alphaHN_U_26 , LB_alphaHN_U_26, UB_alphaHN_U_26,
                                   mean_alphaHN_U_26, mean_alpha_LBHN_U_26, mean_alpha_UBHN_U_26,
                                   Rhat_muDPHN_U_26, Rhat_tau2DPHN_U_26, Rhat_basemuHN_U_26, Rhat_basetauHN_U_26, Rhat_alphaHN_U_26, numclusHN_U_26, LB_KHN_U_26, UB_KHN_U_26)

##########REMOVE Rhats > 1.05 ##############

condition1HN_U_26 <- which(RhatsDPHN_U_26$Rhat_muDPHN_U_26 > 1.05)
condition2HN_U_26 <- which(RhatsDPHN_U_26$Rhat_tau2DPHN_U_26 > 1.05)
condition3HN_U_26 <- which(RhatsDPHN_U_26$Rhat_basemuHN_U_26 > 1.05)
condition4HN_U_26 <- which(RhatsDPHN_U_26$Rhat_basetauHN_U_26 > 1.05)
condition5HN_U_26 <- which(RhatsDPHN_U_26$Rhat_alphaHN_U_26 > 1.05)


dist.condDPHN_U_26 = c(condition1HN_U_26,condition2HN_U_26,condition3HN_U_26,condition4HN_U_26,condition5HN_U_26)
dist.condDPHN_U_26 = unique(dist.condDPHN_U_26)

RhatDP_outHN_U_26 = round((length(dist.condDPHN_U_26)/N.sim), 4)

############### Extract and remove the datasets with Rhat > 1.05 #########
if (length(dist.condDPHN_U_26)== 0) {
  RhatsDPHN_U_26 <- RhatsDPHN_U_26
  listaDPHN_U_26 <- listaDP1HN_U_26
  listaDP_weightsHN_U_26 <- listaDP_weightsHN_U_26
  N.sim <- nrow(RhatsDPHN_U_26)
  pDPHN_U_26 <- p
  
} else {
  RhatsDPHN_U_26 <- RhatsDPHN_U_26[-dist.condDPHN_U_26, ]
  listaDPHN_U_26 <- listaDP1HN_U_26[-dist.condDPHN_U_26]
  listaDP_weightsHN_U_26 <- listaDP_weightsHN_U_26[-dist.condDPHN_U_26]
  N.sim <- nrow(RhatsDPHN_U_26)
  pDPHN_U_26 <- p[-dist.condDPHN_U_26]
}

count_DPHN_U_26 = list()
for(i in length(listaDPHN_U_26)){
  count_DPHN_U_26[[i]] = which(listaDPHN_U_26[[i]]$`Rhat_deltaDPHN_U_26[[i]]` > 1.05 )
  tell_meDPHN_U_26 = which(count_DPHN_U_26[[i]] != 0)
}

tell_meDPHN_U_26

if(length(tell_meDPHN_U_26) == 0){
  RhatsDPHN_U_26 <- RhatsDPHN_U_26
  N.sim <- nrow(RhatsDPHN_U_26)
  listaDPHN_U_26 <- listaDPHN_U_26
  listaDP_weightsHN_U_26 <- listaDP_weightsHN_U_26
  pDPHN_U_26 <- pDPHN_U_26
  RhatDP_outHN_U_26 <- RhatDP_outHN_U_26
} else {
  RhatsDPHN_U_26 <- RhatsDPHN_U_26[-tell_meDPHN_U_26, ]
  listaDPHN_U_26 <- listaDPHN_U_26[-tell_meDPHN_U_26]
  listaDP_weightsHN_U_26 <- listaDP_weightsHN_U_26[-tell_meDPHN_U_26]
  N.sim = nrow(RhatsDPHN_U_26)
  pDPHN_U_26 <- pDPHN_U_26[-tell_meDPHN_U_26]
  RhatDP_outHN_U_26 <- RhatDP_outHN_U_26 + ((length(tell_meDPHN_U_26))/N.sim)
}

RhatDP_outHN_U_26

#### AVERAGE ABSOLUTE BIAS OF mu ######
abs_biasDPjags.binHN_U_26 <- c()
for (i in 1:N.sim){
  abs_biasDPjags.binHN_U_26[i] <- abs( RhatsDPHN_U_26$mu_DPHN_U_26[i] - mu) 
}
avg_abs_biasDPjags.binHN_U_26 <- round(mean(abs_biasDPjags.binHN_U_26),2)

#### AVERAGE DIFFERENCES OF mu ######
rel_biasDPjags.binHN_U_26 <- c()
for (i in 1:N.sim){
  rel_biasDPjags.binHN_U_26[i] <- ( RhatsDPHN_U_26$mu_DPHN_U_26[i] - mu) 
}
avg_rel_biasDPjags.binHN_U_26 <- round(mean(rel_biasDPjags.binHN_U_26),2)

######  MSE OF mu ##########
MSE_DPjags.binHN_U_26 <- c()
for (i in 1:N.sim){
  MSE_DPjags.binHN_U_26[i] <- RMSE(estimate = RhatsDPHN_U_26$mu_DPHN_U_26[i],
                                   parameter = mu,
                                   type = "RMSE",
                                   MSE = TRUE )        
}
avg_MSE_DPjags.binHN_U_26 <- round(mean(MSE_DPjags.binHN_U_26), 4)

############ COVERAGE OF mu ########
interval_contains_true_mean <- function(i) { 
  ( mu >= RhatsDPHN_U_26$LB_mu_DPHN_U_26[i]) && ( mu <= RhatsDPHN_U_26$UB_mu_DPHN_U_26[i])
}
interval_contains_true_mean(i)

coverageDPjags.binHN_U_26 <- c()
for (i in 1:N.sim){
  if (interval_contains_true_mean(i) == TRUE){
    coverageDPjags.binHN_U_26[i] = 1
  }
  else {
    coverageDPjags.binHN_U_26[i]=0
  }
  print(coverageDPjags.binHN_U_26[i])
}
coverageDPjags.binHN_U_26
coverDPjags.binHN_U_26 <- round(mean(coverageDPjags.binHN_U_26)*100, 2)

## BIAS OF base_mu ######
biasDPjags_basemu.binHN_U_26 <- c()
for (i in 1:N.sim){
  biasDPjags_basemu.binHN_U_26[i] <- abs( RhatsDPHN_U_26$base_muHN_U_26[i] - mu) 
}
avg_biasDPjags_basemu.binHN_U_26 <- round(mean(biasDPjags_basemu.binHN_U_26),2)

###### MSE OF base_mu ##########
MSE_DPjags_basemu.binHN_U_26 <- c()
for (i in 1:N.sim){
  MSE_DPjags_basemu.binHN_U_26[i] <- RMSE(estimate =RhatsDPHN_U_26$base_muHN_U_26[i],
                                          parameter = mu,
                                          type = "RMSE",
                                          MSE = TRUE      
  )
}
avg_MSE_DPjags_basemu.binHN_U_26 <- round(mean(MSE_DPjags_basemu.binHN_U_26), 4)

############ COVERAGE OF base_mu ########
interval_contains_true_mean <- function(i) { 
  ( mu >= RhatsDPHN_U_26$LB_base_muHN_U_26[i]) && ( mu <= RhatsDPHN_U_26$UB_base_muHN_U_26[i])
}
interval_contains_true_mean(i)

coverageDPjags_basemu.binHN_U_26 <- c()
for (i in 1:N.sim){
  if (interval_contains_true_mean(i) == TRUE){
    coverageDPjags_basemu.binHN_U_26[i] = 1
  }
  else {
    coverageDPjags_basemu.binHN_U_26[i]=0
  }
  print(coverageDPjags_basemu.binHN_U_26[i])
}
coverageDPjags_basemu.binHN_U_26
coverDPjags_basemu.binHN_U_26 <- round(mean(coverageDPjags_basemu.binHN_U_26)*100, 2)

######## AVERAGE BIAS OF tau2 ###########
bias_tau2DPjags.binHN_U_26 <- c()
for (i in 1:N.sim){
  bias_tau2DPjags.binHN_U_26[i] <- abs(RhatsDPHN_U_26$tau2_DPHN_U_26[i]- tau2)
}
avg_bias_tau2DPjags.binHN_U_26 <- round(mean(bias_tau2DPjags.binHN_U_26),2)

pbias_tau2DPjags.binHN_U_26 <- round(mean(bias_tau2DPjags.binHN_U_26 / tau2),2)

######## MSE OF tau2 #############
MSE_DPjags.bin.tau2HN_U_26 <- c()
for (i in 1:N.sim){
  MSE_DPjags.bin.tau2HN_U_26[i] <- RMSE(estimate =RhatsDPHN_U_26$tau2_DPHN_U_26[i],
                                        parameter = tau2,
                                        type = "RMSE",
                                        MSE = TRUE         
  )
...
avg_MSE_DPjags.bin.tau2HN_U_26 <- round(mean(MSE_DPjags.bin.tau2HN_U_26),4)

nMSE_DPjags.bin.tau2HN_U_26 <- round(mean(MSE_DPjags.bin.tau2HN_U_26/ (tau2)^2),4)

############ COVERAGE OF tau2 ##################
interval_contains_true_mean <- function(i) { 
  ( tau2 >= RhatsDPHN_U_26$LB_tau2_DPHN_U_26[i]) && ( tau2 <= RhatsDPHN_U_26$UB_tau2_DPHN_U_26[i])
}
interval_contains_true_mean(i)

coverage_tau2DPjags.binHN_U_26 <- c()
for (i in 1:N.sim){
  if (interval_contains_true_mean(i) == TRUE){
    coverage_tau2DPjags.binHN_U_26[i] = 1
  }
  else  {
    coverage_tau2DPjags.binHN_U_26[i] = 0
  }
  print(coverage_tau2DPjags.binHN_U_26[i])
}
coverage_tau2DPjags.binHN_U_26
cover_tau2DPjags.binHN_U_26 <- round(mean(coverage_tau2DPjags.binHN_U_26)*100, 2)


######## PERCENT RELATIVE BIAS OF tau ###########
rel_bias_tauDPjags.binHN_U_26 <- c()
for (i in 1:N.sim){
  rel_bias_tauDPjags.binHN_U_26[i] <- (RhatsDPHN_U_26$tau_DPHN_U_26[i]- tau)
}
avg_rel_bias_tauDPjags.binHN_U_26 <- round(mean(rel_bias_tauDPjags.binHN_U_26),2)

prel_bias_tauDPjags.binHN_U_26 <- round(mean(rel_bias_tauDPjags.binHN_U_26 / tau)*100,2)

######## AVERAGE ABSOLUTE  BIAS OF tau ###########
abs_bias_tauDPjags.binHN_U_26 <- c()
for (i in 1:N.sim){
  abs_bias_tauDPjags.binHN_U_26[i] <- abs(RhatsDPHN_U_26$tau_DPHN_U_26[i]- tau)
}
avg_abs_bias_tauDPjags.binHN_U_26 <- round(mean(abs_bias_tauDPjags.binHN_U_26),2)

pabs_bias_tauDPjags.binHN_U_26 <- round(mean(abs_bias_tauDPjags.binHN_U_26 / tau)*100,2)

######## MSE OF tau #############
MSE_DPjags.bin.tauHN_U_26 <- c()
for (i in 1:N.sim){
  MSE_DPjags.bin.tauHN_U_26[i] <- RMSE(estimate =RhatsDPHN_U_26$tau_DPHN_U_26[i],
                                       parameter = tau,
                                       type = "RMSE",
                                       MSE = TRUE         
  )
...
avg_MSE_DPjags.bin.tauHN_U_26 <- round(mean(MSE_DPjags.bin.tauHN_U_26),4)

nMSE_DPjags.bin.tauHN_U_26 <- round(mean(MSE_DPjags.bin.tauHN_U_26/ tau2),4)

############ COVERAGE OF tau ##################
interval_contains_true_mean <- function(i) { 
  ( tau >= RhatsDPHN_U_26$LB_tau_DPHN_U_26[i]) && ( tau <= RhatsDPHN_U_26$UB_tau_DPHN_U_26[i])
}
interval_contains_true_mean(i)

coverage_tauDPjags.binHN_U_26 <- c()
for (i in 1:N.sim){
  if (interval_contains_true_mean(i) == TRUE){
    coverage_tauDPjags.binHN_U_26[i] = 1
  }
  else  {
    coverage_tauDPjags.binHN_U_26[i] = 0
  }
  print(coverage_tauDPjags.binHN_U_26[i])
}
coverage_tauDPjags.binHN_U_26
cover_tauDPjags.binHN_U_26 <- round(mean(coverage_tauDPjags.binHN_U_26)*100, 2)


######## AVERAGE BIAS OF base_tau2 ###########
bias_basetau2DPjags.binHN_U_26 <- c()
for (i in 1:N.sim){
  bias_basetau2DPjags.binHN_U_26[i] <- abs(RhatsDPHN_U_26$base_tau2HN_U_26[i]- tau2)
}
avg_bias_basetau2DPjags.binHN_U_26 <- round(mean(bias_basetau2DPjags.binHN_U_26),2)

######## MSE OF base_tau2 #############
MSE_DPjags.bin.basetau2HN_U_26 <- c()
for (i in 1:N.sim){
  MSE_DPjags.bin.basetau2HN_U_26[i] <- RMSE(estimate =RhatsDPHN_U_26$base_tau2HN_U_26[i],
                                            parameter = tau2,
                                            type = "RMSE",
                                            MSE = TRUE         
  )
...
avg_MSE_DPjags.bin.basetau2HN_U_26 <- round(mean(MSE_DPjags.bin.basetau2HN_U_26),4)

############ COVERAGE OF base_tau2 ##################
interval_contains_true_mean <- function(i) {
  ( tau2 >= RhatsDPHN_U_26$LB_base_tau2HN_U_26[i]) && ( tau2 <= RhatsDPHN_U_26$UB_base_tau2HN_U_26[i])
}
interval_contains_true_mean(i)

coverage_basetau2DPjags.binHN_U_26 <- c()
for (i in 1:N.sim){
  if (interval_contains_true_mean(i) == TRUE){
    coverage_basetau2DPjags.binHN_U_26[i] = 1
  }
  else  {
    coverage_basetau2DPjags.binHN_U_26[i] = 0
  }
  print(coverage_basetau2DPjags.binHN_U_26[i])
}
coverage_basetau2DPjags.binHN_U_26
cover_basetau2DPjags.binHN_U_26 <- round(mean(coverage_basetau2DPjags.binHN_U_26)*100, 2)

######################## ABSOLUTE BIAS OF RELATIVE EFFECTS ##################
abs_bias_relDPHN_U_26 <- list()
mean_abs_bias_relDPHN_U_26 <- list()
for(i in 1:N.sim){
  for(j in 1:nrow(pDPHN_U_26[[i]])){
    abs_bias_relDPHN_U_26[[i]] <- round(abs(listaDPHN_U_26[[i]]$`rel_effDPHN_U_26[[i]]` - pDPHN_U_26[[i]]$true_eff ),2)
    mean_abs_bias_relDPHN_U_26[[i]] <- mean(abs_bias_relDPHN_U_26[[i]])
  }
}
#mean_bias_relDP

################## mean bias of the mean biases of each data set for relative effects  ###################
mean_abs_bias_of_mean_abs_bias_relDPHN_U_26 <- unlist(mean_abs_bias_relDPHN_U_26)
mean_abs_bias_of_mean_abs_bias_relDPHN_U_26  <- round(mean(mean_abs_bias_of_mean_abs_bias_relDPHN_U_26),2)

######################## AVERAGE DIFFERENCES OF RELATIVE EFFECTS ##################
rel_bias_relDPHN_U_26 <- list()
mean_rel_bias_relDPHN_U_26 <- list()
for(i in 1:N.sim){
  for(j in 1:nrow(pDPHN_U_26[[i]])){
    rel_bias_relDPHN_U_26[[i]] <- round((listaDPHN_U_26[[i]]$`rel_effDPHN_U_26[[i]]` - pDPHN_U_26[[i]]$true_eff ),2)
    mean_rel_bias_relDPHN_U_26[[i]] <- mean(rel_bias_relDPHN_U_26[[i]])
  }
}
#mean_bias_relDP

################## mean bias of the mean biases of each data set for relative effects  ###################
mean_rel_bias_of_mean_rel_bias_relDPHN_U_26 <- unlist(mean_rel_bias_relDPHN_U_26)
mean_rel_bias_of_mean_rel_bias_relDPHN_U_26  <- round(mean(mean_rel_bias_of_mean_rel_bias_relDPHN_U_26),2)

#####
########################### FOR THE OVERLAPPING ######################
dataDPHN_U_26 <- list()
overlapDP1HN_U_26 <- list()
overlapDPHN_U_26 <- list()
for(i in 1:N.sim){
  dataDPHN_U_26[[i]] <- list(DP = listaDPHN_U_26[[i]]$`rel_effDPHN_U_26[[i]]` , True = pDPHN_U_26[[i]]$true_eff  )
  overlapDP1HN_U_26[[i]] <- overlap(dataDPHN_U_26[[i]], type = "2")
  overlapDPHN_U_26[[i]] <- overlapDP1HN_U_26[[i]]$OV
}
overlapDPHN_U_26 <- unlist(overlapDPHN_U_26)
avg_overlapDPHN_U_26 <- round(mean(overlapDPHN_U_26),2)


listaDP_rel_effHN_U_26 <- cbind( mean_abs_bias_relDPHN_U_26, mean_abs_bias_of_mean_abs_bias_relDPHN_U_26,
                                 mean_rel_bias_relDPHN_U_26, mean_rel_bias_of_mean_rel_bias_relDPHN_U_26) 

######### SAVE THE OUTPUTS ###########
DP_bin_jagsHN_U_26 <- cbind(RhatsDPHN_U_26,
                            abs_biasDPjags.binHN_U_26, rel_biasDPjags.binHN_U_26,
                            MSE_DPjags.binHN_U_26, biasDPjags_basemu.binHN_U_26, MSE_DPjags_basemu.binHN_U_26,
                            bias_tau2DPjags.binHN_U_26,rel_bias_tauDPjags.binHN_U_26, abs_bias_tauDPjags.binHN_U_26, 
                            MSE_DPjags.bin.tau2HN_U_26, MSE_DPjags.bin.tauHN_U_26,
                            bias_basetau2DPjags.binHN_U_26, MSE_DPjags.bin.basetau2HN_U_26, 
                            avg_abs_biasDPjags.binHN_U_26, avg_rel_biasDPjags.binHN_U_26, 
                            avg_biasDPjags_basemu.binHN_U_26, 
                            avg_bias_tau2DPjags.binHN_U_26,pbias_tau2DPjags.binHN_U_26,avg_rel_bias_tauDPjags.binHN_U_26,avg_abs_bias_tauDPjags.binHN_U_26,
                            prel_bias_tauDPjags.binHN_U_26,pabs_bias_tauDPjags.binHN_U_26,
                            avg_bias_basetau2DPjags.binHN_U_26,
                            rel_bias_tauDPjags.binHN_U_26,abs_bias_tauDPjags.binHN_U_26,
                            avg_MSE_DPjags.binHN_U_26,avg_MSE_DPjags_basemu.binHN_U_26,avg_MSE_DPjags.bin.tau2HN_U_26, nMSE_DPjags.bin.tau2HN_U_26,
                            avg_MSE_DPjags.bin.tauHN_U_26, nMSE_DPjags.bin.tauHN_U_26,
                            avg_MSE_DPjags.bin.basetau2HN_U_26,
                            coverageDPjags.binHN_U_26 , coverageDPjags_basemu.binHN_U_26, coverage_tau2DPjags.binHN_U_26, coverage_basetau2DPjags.binHN_U_26, 
                            coverage_tauDPjags.binHN_U_26, 
                            coverDPjags.binHN_U_26, coverDPjags_basemu.binHN_U_26, cover_tau2DPjags.binHN_U_26, cover_tauDPjags.binHN_U_26,
                            cover_basetau2DPjags.binHN_U_26, RhatDP_outHN_U_26)

Overlap_DPmodelHN_U_26 <- cbind(overlapDPHN_U_26, avg_overlapDPHN_U_26)                    

write.csv(DP_bin_jagsHN_U_26, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\DP MODEL\\rev_HN_UNIF_26_ResultsDP_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
write.csv(listaDPHN_U_26, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\DP MODEL\\rev_HN_UNIF_26_Relative_eff_ResultsDP_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
write.csv(listaDP_rel_effHN_U_26, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\DP MODEL\\rev_HN_UNIF_26_Bias_Relative_eff_ResultsDP_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
write.csv(Overlap_DPmodelHN_U_26,"C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\DP MODEL\\rev_HN_UNIF_26_Overlap_DPmodel_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=TRUE ) 
write.csv(listaDP_weightsHN_U_26,"C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\DP MODEL\\rev_HN_UNIF_26_Weights_in_clusters_jags_DP_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=TRUE ) 
...
cl = makeCluster(19)
registerDoParallel(cl)
DPresults1HN_U_51 <- list()

DPresults1HN_U_51 = foreach(i = 1:N.sim,.packages = c("rjags", "R2jags","tidyverse")) %dopar% {
  set.seed(274)
  run.model = jags(
    data =list(ns = nrow(p[[i]]),
               r1 = p[[i]]$ci,
...
DPresultsHN_U_51 <- list()
posteriorDPHN_U_51 <- list()
postDPHN_U_51 <- list()
for(i in 1:N.sim){
  DPresultsHN_U_51[[i]] <- as.data.frame(DPresults1HN_U_51[[i]]$BUGSoutput$summary) 
  posteriorDPHN_U_51[[i]] = as.data.frame(DPresults1HN_U_51[[i]]$BUGSoutput$sims.matrix)
  postDPHN_U_51[[i]] <- posteriorDPHN_U_51[[i]]$poptrue
}

DP_resultsHN_U_51 <- list()
for(i in 1:N.sim){
  DP_resultsHN_U_51[[i]] <- DPresultsHN_U_51[[i]] 
}
...
UB_tau2_DPHN_U_51 <- c()
precDP_muHN_U_51 <- c()
precDP_tau2HN_U_51 <- c()
prec_basemuHN_U_51 <- c()
prec_basetau2HN_U_51 <- c()
prec_alphaHN_U_51 <- c()
base_muHN_U_51 <- c()
base_tauHN_U_51 <- c()
base_tau2HN_U_51 <- c()
LB_base_muHN_U_51 <- c()
UB_base_muHN_U_51 <- c()
LB_base_tau2HN_U_51 <- c()
UB_base_tau2HN_U_51 <- c()
Rhat_muDPHN_U_51 <- c()
Rhat_tau2DPHN_U_51 <- c()
Rhat_basemuHN_U_51 <- c()
Rhat_basetauHN_U_51 <- c()
Rhat_alphaHN_U_51 <- c()
Rhat_deltaDPHN_U_51 <- list()
median_KHN_U_51 <- list()
LB_KHN_U_51 <- list()
UB_KHN_U_51 <- list()
rel_effDPHN_U_51 <- list()
LB_rel_effDPHN_U_51 <- list()
UB_rel_effDPHN_U_51 <- list()
sd_rel_effDPHN_U_51 <- list()
piHN_U_51 <- list()
f11HN_U_51 <- list()
m11HN_U_51 <- list()
f22HN_U_51 <- list()
...
fpHN_U_51 <- list()
mpHN_U_51 <- list()
listaDP1HN_U_51 <- list()
listaDP_weightsHN_U_51 <- list()
for(i in 1:N.sim){
  f11HN_U_51[[i]] <- grepl("poptrue", row.names(DP_resultsHN_U_51[[i]]))
  m11HN_U_51[[i]] <- DP_resultsHN_U_51[[i]][f11HN_U_51[[i]],]
  mu_DPHN_U_51[i] <- m11HN_U_51[[i]]$`50%`
  LB_mu_DPHN_U_51[i] <- m11HN_U_51[[i]]$`2.5%`
  UB_mu_DPHN_U_51[i] <- m11HN_U_51[[i]]$`97.5%`
  Rhat_muDPHN_U_51[i] <- m11HN_U_51[[i]]$Rhat
  precDP_muHN_U_51[i] <- UB_mu_DPHN_U_51[i] - LB_mu_DPHN_U_51[i]
  
  f22HN_U_51[[i]] <- grepl("var.true", row.names(DP_resultsHN_U_51[[i]]))
  m22HN_U_51[[i]] <- DP_resultsHN_U_51[[i]][f22HN_U_51[[i]],]
  tau2_DPHN_U_51[i] <- m22HN_U_51[[i]]$`50%`
  LB_tau2_DPHN_U_51[i] <- m22HN_U_51[[i]]$`2.5%`
  UB_tau2_DPHN_U_51[i] <- m22HN_U_51[[i]]$`97.5%`
  Rhat_tau2DPHN_U_51[i] <- m22HN_U_51[[i]]$Rhat
  precDP_tau2HN_U_51[i] <- UB_tau2_DPHN_U_51[i] -  LB_tau2_DPHN_U_51[i]
  
  fddHN_U_51[[i]] <- grepl("delta12", row.names(DP_resultsHN_U_51[[i]]))
  mddHN_U_51[[i]] <- DP_resultsHN_U_51[[i]][fddHN_U_51[[i]],]
  rel_effDPHN_U_51[[i]] <- mddHN_U_51[[i]]$`50%`
  LB_rel_effDPHN_U_51[[i]] <- mddHN_U_51[[i]]$`2.5%`
  UB_rel_effDPHN_U_51[[i]] <- mddHN_U_51[[i]]$`97.5%`
  sd_rel_effDPHN_U_51[[i]] <- mddHN_U_51[[i]]$sd
  Rhat_deltaDPHN_U_51[[i]] <- mddHN_U_51[[i]]$Rhat
  
  f33HN_U_51[[i]] <- grepl("basemu", row.names(DP_resultsHN_U_51[[i]]))
  m33HN_U_51[[i]] <- DP_resultsHN_U_51[[i]][f33HN_U_51[[i]],]
  base_muHN_U_51[i] <- m33HN_U_51[[i]]$`50%`
  LB_base_muHN_U_51[i] <- m33HN_U_51[[i]]$`2.5%`
  UB_base_muHN_U_51[i] <- m33HN_U_51[[i]]$`97.5%`
  Rhat_basemuHN_U_51[i] <- m33HN_U_51[[i]]$Rhat
  prec_basemuHN_U_51[i] <- UB_base_muHN_U_51[i] - LB_base_muHN_U_51[i]
  
  f44HN_U_51[[i]] <- grepl("basetau", row.names(DP_resultsHN_U_51[[i]]))
  m44HN_U_51[[i]] <- DP_resultsHN_U_51[[i]][f44HN_U_51[[i]],]
  base_tauHN_U_51[i] <- m44HN_U_51[[i]]$`50%`
  base_tau2HN_U_51[i] <- (m44HN_U_51[[i]]$`50%`)^2
  LB_base_tau2HN_U_51[i] <- (m44HN_U_51[[i]]$`2.5%`)^2
  UB_base_tau2HN_U_51[i] <- (m44HN_U_51[[i]]$`97.5%`)^2
  Rhat_basetauHN_U_51[i] <- (m44HN_U_51[[i]]$Rhat)^2
  prec_basetau2HN_U_51[i] <- UB_base_tau2HN_U_51[i] - LB_base_tau2HN_U_51[i]
  
  f55HN_U_51[[i]] <- grepl("alpha", row.names(DP_resultsHN_U_51[[i]]))
  m55HN_U_51[[i]] <- DP_resultsHN_U_51[[i]][f55HN_U_51[[i]],]
  alphaHN_U_51[i] <- m55HN_U_51[[i]]$`50%`
  LB_alphaHN_U_51[i] <- m55HN_U_51[[i]]$`2.5%`
  UB_alphaHN_U_51[i] <- m55HN_U_51[[i]]$`97.5%`
  Rhat_alphaHN_U_51[i] <- m55HN_U_51[[i]]$Rhat
  prec_alphaHN_U_51[i] <- UB_alphaHN_U_51[i] - LB_alphaHN_U_51[i]
  
  fclHN_U_51[[i]] <- grepl("K", row.names(DP_resultsHN_U_51[[i]]))  
  mclHN_U_51[[i]] <- DP_resultsHN_U_51[[i]][fclHN_U_51[[i]],]
  median_KHN_U_51[[i]] <- mclHN_U_51[[i]]$`50%` 
  LB_KHN_U_51[[i]] <- mclHN_U_51[[i]]$`2.5%`
  UB_KHN_U_51[[i]] <- mclHN_U_51[[i]]$`97.5%`
  
  fpHN_U_51[[i]] <- grepl("p", row.names(DP_resultsHN_U_51[[i]]))
  mpHN_U_51[[i]] <- DP_resultsHN_U_51[[i]][fpHN_U_51[[i]],]
  mpHN_U_51[[i]] <- mpHN_U_51[[i]][!grepl("pop", row.names(mpHN_U_51[[i]])),]
  mpHN_U_51[[i]] <- mpHN_U_51[[i]][!grepl("alpha", row.names(mpHN_U_51[[i]])),]
  piHN_U_51[[i]] <- mpHN_U_51[[i]]$mean
  
  listaDP1HN_U_51[[i]] <- cbind.data.frame(rel_effDPHN_U_51[[i]],sd_rel_effDPHN_U_51[[i]], LB_rel_effDPHN_U_51[[i]],UB_rel_effDPHN_U_51[[i]],Rhat_deltaDPHN_U_51[[i]])
  listaDP_weightsHN_U_51[[i]] <- cbind.data.frame(piHN_U_51[[i]])
  
}

numclusHN_U_51 <- unlist(median_KHN_U_51)
LB_KHN_U_51 <- unlist(LB_KHN_U_51)
UB_KHN_U_51 <- unlist(UB_KHN_U_51)

mean_alphaHN_U_51 = mean(alphaHN_U_51)
mean_alpha_LBHN_U_51 = mean(LB_alphaHN_U_51)
mean_alpha_UBHN_U_51 = mean(UB_alphaHN_U_51)

tau_DPHN_U_51 = sqrt(tau2_DPHN_U_51)
LB_tau_DPHN_U_51 = sqrt(LB_tau2_DPHN_U_51)
UB_tau_DPHN_U_51 = sqrt(UB_tau2_DPHN_U_51)
precDP_tauHN_U_51 = UB_tau_DPHN_U_51 -  LB_tau_DPHN_U_51


RhatsDPHN_U_51 <- cbind.data.frame(base_muHN_U_51,LB_base_muHN_U_51,UB_base_muHN_U_51,base_tauHN_U_51,base_tau2HN_U_51, LB_base_tau2HN_U_51,UB_base_tau2HN_U_51,
                                   mu_DPHN_U_51, LB_mu_DPHN_U_51, UB_mu_DPHN_U_51, tau2_DPHN_U_51, LB_tau2_DPHN_U_51, UB_tau2_DPHN_U_51,
                                   tau_DPHN_U_51, LB_tau_DPHN_U_51, UB_tau_DPHN_U_51,
                                   precDP_muHN_U_51, precDP_tau2HN_U_51, prec_basemuHN_U_51, prec_basetau2HN_U_51,prec_alphaHN_U_51,  alphaHN_U_51 , LB_alphaHN_U_51, UB_alphaHN_U_51,
                                   mean_alphaHN_U_51, mean_alpha_LBHN_U_51, mean_alpha_UBHN_U_51,
                                   Rhat_muDPHN_U_51, Rhat_tau2DPHN_U_51, Rhat_basemuHN_U_51, Rhat_basetauHN_U_51, Rhat_alphaHN_U_51, numclusHN_U_51, LB_KHN_U_51, UB_KHN_U_51)

##########REMOVE Rhats > 1.05 ##############

condition1HN_U_51 <- which(RhatsDPHN_U_51$Rhat_muDPHN_U_51 > 1.05)
condition2HN_U_51 <- which(RhatsDPHN_U_51$Rhat_tau2DPHN_U_51 > 1.05)
condition3HN_U_51 <- which(RhatsDPHN_U_51$Rhat_basemuHN_U_51 > 1.05)
condition4HN_U_51 <- which(RhatsDPHN_U_51$Rhat_basetauHN_U_51 > 1.05)
condition5HN_U_51 <- which(RhatsDPHN_U_51$Rhat_alphaHN_U_51 > 1.05)


dist.condDPHN_U_51 = c(condition1HN_U_51,condition2HN_U_51,condition3HN_U_51,condition4HN_U_51,condition5HN_U_51)
dist.condDPHN_U_51 = unique(dist.condDPHN_U_51)

RhatDP_outHN_U_51 = round((length(dist.condDPHN_U_51)/N.sim), 4)

############### Extract and remove the datasets with Rhat > 1.05 #########
if (length(dist.condDPHN_U_51)== 0) {
  RhatsDPHN_U_51 <- RhatsDPHN_U_51
  listaDPHN_U_51 <- listaDP1HN_U_51
  listaDP_weightsHN_U_51 <- listaDP_weightsHN_U_51
  N.sim <- nrow(RhatsDPHN_U_51)
  pDPHN_U_51 <- p
  
} else {
  RhatsDPHN_U_51 <- RhatsDPHN_U_51[-dist.condDPHN_U_51, ]
  listaDPHN_U_51 <- listaDP1HN_U_51[-dist.condDPHN_U_51]
  listaDP_weightsHN_U_51 <- listaDP_weightsHN_U_51[-dist.condDPHN_U_51]
  N.sim <- nrow(RhatsDPHN_U_51)
  pDPHN_U_51 <- p[-dist.condDPHN_U_51]
}

count_DPHN_U_51 = list()
for(i in length(listaDPHN_U_51)){
  count_DPHN_U_51[[i]] = which(listaDPHN_U_51[[i]]$`Rhat_deltaDPHN_U_51[[i]]` > 1.05 )
  tell_meDPHN_U_51 = which(count_DPHN_U_51[[i]] != 0)
}

tell_meDPHN_U_51

if(length(tell_meDPHN_U_51) == 0){
  RhatsDPHN_U_51 <- RhatsDPHN_U_51
  N.sim <- nrow(RhatsDPHN_U_51)
  listaDPHN_U_51 <- listaDPHN_U_51
  listaDP_weightsHN_U_51 <- listaDP_weightsHN_U_51
  pDPHN_U_51 <- pDPHN_U_51
  RhatDP_outHN_U_51 <- RhatDP_outHN_U_51
} else {
  RhatsDPHN_U_51 <- RhatsDPHN_U_51[-tell_meDPHN_U_51, ]
  listaDPHN_U_51 <- listaDPHN_U_51[-tell_meDPHN_U_51]
  listaDP_weightsHN_U_51 <- listaDP_weightsHN_U_51[-tell_meDPHN_U_51]
  N.sim = nrow(RhatsDPHN_U_51)
  pDPHN_U_51 <- pDPHN_U_51[-tell_meDPHN_U_51]
  RhatDP_outHN_U_51 <- RhatDP_outHN_U_51 + ((length(tell_meDPHN_U_51))/N.sim)
}

RhatDP_outHN_U_51

#### AVERAGE ABSOLUTE BIAS OF mu ######
abs_biasDPjags.binHN_U_51 <- c()
for (i in 1:N.sim){
  abs_biasDPjags.binHN_U_51[i] <- abs( RhatsDPHN_U_51$mu_DPHN_U_51[i] - mu) 
}
avg_abs_biasDPjags.binHN_U_51 <- round(mean(abs_biasDPjags.binHN_U_51),2)

#### AVERAGE DIFFERENCES OF mu ######
rel_biasDPjags.binHN_U_51 <- c()
for (i in 1:N.sim){
  rel_biasDPjags.binHN_U_51[i] <- ( RhatsDPHN_U_51$mu_DPHN_U_51[i] - mu) 
}
avg_rel_biasDPjags.binHN_U_51 <- round(mean(rel_biasDPjags.binHN_U_51),2)

######  MSE OF mu ##########
MSE_DPjags.binHN_U_51 <- c()
for (i in 1:N.sim){
  MSE_DPjags.binHN_U_51[i] <- RMSE(estimate = RhatsDPHN_U_51$mu_DPHN_U_51[i],
                                   parameter = mu,
                                   type = "RMSE",
                                   MSE = TRUE )        
}
avg_MSE_DPjags.binHN_U_51 <- round(mean(MSE_DPjags.binHN_U_51), 4)

############ COVERAGE OF mu ########
interval_contains_true_mean <- function(i) { 
  ( mu >= RhatsDPHN_U_51$LB_mu_DPHN_U_51[i]) && ( mu <= RhatsDPHN_U_51$UB_mu_DPHN_U_51[i])
}
interval_contains_true_mean(i)

coverageDPjags.binHN_U_51 <- c()
for (i in 1:N.sim){
  if (interval_contains_true_mean(i) == TRUE){
    coverageDPjags.binHN_U_51[i] = 1
  }
  else {
    coverageDPjags.binHN_U_51[i]=0
  }
  print(coverageDPjags.binHN_U_51[i])
}
coverageDPjags.binHN_U_51
coverDPjags.binHN_U_51 <- round(mean(coverageDPjags.binHN_U_51)*100, 2)

## BIAS OF base_mu ######
biasDPjags_basemu.binHN_U_51 <- c()
for (i in 1:N.sim){
  biasDPjags_basemu.binHN_U_51[i] <- abs( RhatsDPHN_U_51$base_muHN_U_51[i] - mu) 
}
avg_biasDPjags_basemu.binHN_U_51 <- round(mean(biasDPjags_basemu.binHN_U_51),2)

###### MSE OF base_mu ##########
MSE_DPjags_basemu.binHN_U_51 <- c()
for (i in 1:N.sim){
  MSE_DPjags_basemu.binHN_U_51[i] <- RMSE(estimate =RhatsDPHN_U_51$base_muHN_U_51[i],
                                          parameter = mu,
                                          type = "RMSE",
                                          MSE = TRUE      
  )
}
avg_MSE_DPjags_basemu.binHN_U_51 <- round(mean(MSE_DPjags_basemu.binHN_U_51), 4)

############ COVERAGE OF base_mu ########
interval_contains_true_mean <- function(i) { 
  ( mu >= RhatsDPHN_U_51$LB_base_muHN_U_51[i]) && ( mu <= RhatsDPHN_U_51$UB_base_muHN_U_51[i])
}
interval_contains_true_mean(i)

coverageDPjags_basemu.binHN_U_51 <- c()
for (i in 1:N.sim){
  if (interval_contains_true_mean(i) == TRUE){
    coverageDPjags_basemu.binHN_U_51[i] = 1
  }
  else {
    coverageDPjags_basemu.binHN_U_51[i]=0
  }
  print(coverageDPjags_basemu.binHN_U_51[i])
}
coverageDPjags_basemu.binHN_U_51
coverDPjags_basemu.binHN_U_51 <- round(mean(coverageDPjags_basemu.binHN_U_51)*100, 2)

######## AVERAGE BIAS OF tau2 ###########
bias_tau2DPjags.binHN_U_51 <- c()
for (i in 1:N.sim){
  bias_tau2DPjags.binHN_U_51[i] <- abs(RhatsDPHN_U_51$tau2_DPHN_U_51[i]- tau2)
}
avg_bias_tau2DPjags.binHN_U_51 <- round(mean(bias_tau2DPjags.binHN_U_51),2)

pbias_tau2DPjags.binHN_U_51 <- round(mean(bias_tau2DPjags.binHN_U_51 / tau2),2)

######## MSE OF tau2 #############
MSE_DPjags.bin.tau2HN_U_51 <- c()
for (i in 1:N.sim){
  MSE_DPjags.bin.tau2HN_U_51[i] <- RMSE(estimate =RhatsDPHN_U_51$tau2_DPHN_U_51[i],
                                        parameter = tau2,
                                        type = "RMSE",
                                        MSE = TRUE         
  )
...
avg_MSE_DPjags.bin.tau2HN_U_51 <- round(mean(MSE_DPjags.bin.tau2HN_U_51),4)

nMSE_DPjags.bin.tau2HN_U_51 <- round(mean(MSE_DPjags.bin.tau2HN_U_51/ (tau2)^2),4)

############ COVERAGE OF tau2 ##################
interval_contains_true_mean <- function(i) { 
  ( tau2 >= RhatsDPHN_U_51$LB_tau2_DPHN_U_51[i]) && ( tau2 <= RhatsDPHN_U_51$UB_tau2_DPHN_U_51[i])
}
interval_contains_true_mean(i)

coverage_tau2DPjags.binHN_U_51 <- c()
for (i in 1:N.sim){
  if (interval_contains_true_mean(i) == TRUE){
    coverage_tau2DPjags.binHN_U_51[i] = 1
  }
  else  {
    coverage_tau2DPjags.binHN_U_51[i] = 0
  }
  print(coverage_tau2DPjags.binHN_U_51[i])
}
coverage_tau2DPjags.binHN_U_51
cover_tau2DPjags.binHN_U_51 <- round(mean(coverage_tau2DPjags.binHN_U_51)*100, 2)


######## PERCENT RELATIVE BIAS OF tau ###########
rel_bias_tauDPjags.binHN_U_51 <- c()
for (i in 1:N.sim){
  rel_bias_tauDPjags.binHN_U_51[i] <- (RhatsDPHN_U_51$tau_DPHN_U_51[i]- tau)
}
avg_rel_bias_tauDPjags.binHN_U_51 <- round(mean(rel_bias_tauDPjags.binHN_U_51),2)

prel_bias_tauDPjags.binHN_U_51 <- round(mean(rel_bias_tauDPjags.binHN_U_51 / tau)*100,2)

######## AVERAGE ABSOLUTE  BIAS OF tau ###########
abs_bias_tauDPjags.binHN_U_51 <- c()
for (i in 1:N.sim){
  abs_bias_tauDPjags.binHN_U_51[i] <- abs(RhatsDPHN_U_51$tau_DPHN_U_51[i]- tau)
}
avg_abs_bias_tauDPjags.binHN_U_51 <- round(mean(abs_bias_tauDPjags.binHN_U_51),2)

pabs_bias_tauDPjags.binHN_U_51 <- round(mean(abs_bias_tauDPjags.binHN_U_51 / tau)*100,2)

######## MSE OF tau #############
MSE_DPjags.bin.tauHN_U_51 <- c()
for (i in 1:N.sim){
  MSE_DPjags.bin.tauHN_U_51[i] <- RMSE(estimate =RhatsDPHN_U_51$tau_DPHN_U_51[i],
                                       parameter = tau,
                                       type = "RMSE",
                                       MSE = TRUE         
  )
...
avg_MSE_DPjags.bin.tauHN_U_51 <- round(mean(MSE_DPjags.bin.tauHN_U_51),4)

nMSE_DPjags.bin.tauHN_U_51 <- round(mean(MSE_DPjags.bin.tauHN_U_51/ tau2),4)

############ COVERAGE OF tau ##################
interval_contains_true_mean <- function(i) { 
  ( tau >= RhatsDPHN_U_51$LB_tau_DPHN_U_51[i]) && ( tau <= RhatsDPHN_U_51$UB_tau_DPHN_U_51[i])
}
interval_contains_true_mean(i)

coverage_tauDPjags.binHN_U_51 <- c()
for (i in 1:N.sim){
  if (interval_contains_true_mean(i) == TRUE){
    coverage_tauDPjags.binHN_U_51[i] = 1
  }
  else  {
    coverage_tauDPjags.binHN_U_51[i] = 0
  }
  print(coverage_tauDPjags.binHN_U_51[i])
}
coverage_tauDPjags.binHN_U_51
cover_tauDPjags.binHN_U_51 <- round(mean(coverage_tauDPjags.binHN_U_51)*100, 2)


######## AVERAGE BIAS OF base_tau2 ###########
bias_basetau2DPjags.binHN_U_51 <- c()
for (i in 1:N.sim){
  bias_basetau2DPjags.binHN_U_51[i] <- abs(RhatsDPHN_U_51$base_tau2HN_U_51[i]- tau2)
}
avg_bias_basetau2DPjags.binHN_U_51 <- round(mean(bias_basetau2DPjags.binHN_U_51),2)

######## MSE OF base_tau2 #############
MSE_DPjags.bin.basetau2HN_U_51 <- c()
for (i in 1:N.sim){
  MSE_DPjags.bin.basetau2HN_U_51[i] <- RMSE(estimate =RhatsDPHN_U_51$base_tau2HN_U_51[i],
                                            parameter = tau2,
                                            type = "RMSE",
                                            MSE = TRUE         
  )
...
avg_MSE_DPjags.bin.basetau2HN_U_51 <- round(mean(MSE_DPjags.bin.basetau2HN_U_51),4)

############ COVERAGE OF base_tau2 ##################
interval_contains_true_mean <- function(i) {
  ( tau2 >= RhatsDPHN_U_51$LB_base_tau2HN_U_51[i]) && ( tau2 <= RhatsDPHN_U_51$UB_base_tau2HN_U_51[i])
}
interval_contains_true_mean(i)

coverage_basetau2DPjags.binHN_U_51 <- c()
for (i in 1:N.sim){
  if (interval_contains_true_mean(i) == TRUE){
    coverage_basetau2DPjags.binHN_U_51[i] = 1
  }
  else  {
    coverage_basetau2DPjags.binHN_U_51[i] = 0
  }
  print(coverage_basetau2DPjags.binHN_U_51[i])
}
coverage_basetau2DPjags.binHN_U_51
cover_basetau2DPjags.binHN_U_51 <- round(mean(coverage_basetau2DPjags.binHN_U_51)*100, 2)

######################## ABSOLUTE BIAS OF RELATIVE EFFECTS ##################
abs_bias_relDPHN_U_51 <- list()
mean_abs_bias_relDPHN_U_51 <- list()
for(i in 1:N.sim){
  for(j in 1:nrow(pDPHN_U_51[[i]])){
    abs_bias_relDPHN_U_51[[i]] <- round(abs(listaDPHN_U_51[[i]]$`rel_effDPHN_U_51[[i]]` - pDPHN_U_51[[i]]$true_eff ),2)
    mean_abs_bias_relDPHN_U_51[[i]] <- mean(abs_bias_relDPHN_U_51[[i]])
  }
}
#mean_bias_relDP

################## mean bias of the mean biases of each data set for relative effects  ###################
mean_abs_bias_of_mean_abs_bias_relDPHN_U_51 <- unlist(mean_abs_bias_relDPHN_U_51)
mean_abs_bias_of_mean_abs_bias_relDPHN_U_51  <- round(mean(mean_abs_bias_of_mean_abs_bias_relDPHN_U_51),2)

######################## AVERAGE DIFFERENCES OF RELATIVE EFFECTS ##################
rel_bias_relDPHN_U_51 <- list()
mean_rel_bias_relDPHN_U_51 <- list()
for(i in 1:N.sim){
  for(j in 1:nrow(pDPHN_U_51[[i]])){
    rel_bias_relDPHN_U_51[[i]] <- round((listaDPHN_U_51[[i]]$`rel_effDPHN_U_51[[i]]` - pDPHN_U_51[[i]]$true_eff ),2)
    mean_rel_bias_relDPHN_U_51[[i]] <- mean(rel_bias_relDPHN_U_51[[i]])
  }
}
#mean_bias_relDP

################## mean bias of the mean biases of each data set for relative effects  ###################
mean_rel_bias_of_mean_rel_bias_relDPHN_U_51 <- unlist(mean_rel_bias_relDPHN_U_51)
mean_rel_bias_of_mean_rel_bias_relDPHN_U_51  <- round(mean(mean_rel_bias_of_mean_rel_bias_relDPHN_U_51),2)

#####
########################### FOR THE OVERLAPPING ######################
dataDPHN_U_51 <- list()
overlapDP1HN_U_51 <- list()
overlapDPHN_U_51 <- list()
for(i in 1:N.sim){
  dataDPHN_U_51[[i]] <- list(DP = listaDPHN_U_51[[i]]$`rel_effDPHN_U_51[[i]]` , True = pDPHN_U_51[[i]]$true_eff  )
  overlapDP1HN_U_51[[i]] <- overlap(dataDPHN_U_51[[i]], type = "2")
  overlapDPHN_U_51[[i]] <- overlapDP1HN_U_51[[i]]$OV
}
overlapDPHN_U_51 <- unlist(overlapDPHN_U_51)
avg_overlapDPHN_U_51 <- round(mean(overlapDPHN_U_51),2)


listaDP_rel_effHN_U_51 <- cbind( mean_abs_bias_relDPHN_U_51, mean_abs_bias_of_mean_abs_bias_relDPHN_U_51,
                                 mean_rel_bias_relDPHN_U_51, mean_rel_bias_of_mean_rel_bias_relDPHN_U_51) 

######### SAVE THE OUTPUTS ###########
DP_bin_jagsHN_U_51 <- cbind(RhatsDPHN_U_51,
                            abs_biasDPjags.binHN_U_51, rel_biasDPjags.binHN_U_51,
                            MSE_DPjags.binHN_U_51, biasDPjags_basemu.binHN_U_51, MSE_DPjags_basemu.binHN_U_51,
                            bias_tau2DPjags.binHN_U_51,rel_bias_tauDPjags.binHN_U_51, abs_bias_tauDPjags.binHN_U_51, 
                            MSE_DPjags.bin.tau2HN_U_51, MSE_DPjags.bin.tauHN_U_51,
                            bias_basetau2DPjags.binHN_U_51, MSE_DPjags.bin.basetau2HN_U_51, 
                            avg_abs_biasDPjags.binHN_U_51, avg_rel_biasDPjags.binHN_U_51, 
                            avg_biasDPjags_basemu.binHN_U_51, 
                            avg_bias_tau2DPjags.binHN_U_51,pbias_tau2DPjags.binHN_U_51,avg_rel_bias_tauDPjags.binHN_U_51,avg_abs_bias_tauDPjags.binHN_U_51,
                            prel_bias_tauDPjags.binHN_U_51,pabs_bias_tauDPjags.binHN_U_51,
                            avg_bias_basetau2DPjags.binHN_U_51,
                            rel_bias_tauDPjags.binHN_U_51,abs_bias_tauDPjags.binHN_U_51,
                            avg_MSE_DPjags.binHN_U_51,avg_MSE_DPjags_basemu.binHN_U_51,avg_MSE_DPjags.bin.tau2HN_U_51, nMSE_DPjags.bin.tau2HN_U_51,
                            avg_MSE_DPjags.bin.tauHN_U_51, nMSE_DPjags.bin.tauHN_U_51,
                            avg_MSE_DPjags.bin.basetau2HN_U_51,
                            coverageDPjags.binHN_U_51 , coverageDPjags_basemu.binHN_U_51, coverage_tau2DPjags.binHN_U_51, coverage_basetau2DPjags.binHN_U_51, 
                            coverage_tauDPjags.binHN_U_51, 
                            coverDPjags.binHN_U_51, coverDPjags_basemu.binHN_U_51, cover_tau2DPjags.binHN_U_51, cover_tauDPjags.binHN_U_51,
                            cover_basetau2DPjags.binHN_U_51, RhatDP_outHN_U_51)

Overlap_DPmodelHN_U_51 <- cbind(overlapDPHN_U_51, avg_overlapDPHN_U_51)                    

write.csv(DP_bin_jagsHN_U_51, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\DP MODEL\\rev_HN_U51_ResultsDP_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
write.csv(listaDPHN_U_51, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\DP MODEL\\rev_HN_U51_Relative_eff_ResultsDP_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
write.csv(listaDP_rel_effHN_U_51, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\DP MODEL\\rev_HN_U51_Bias_Relative_eff_ResultsDP_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
write.csv(listaDP_weightsHN_U_51, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\DP MODEL\\rev_HN_U51_Weights_in_clusters_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=TRUE )  
write.csv(Overlap_DPmodelHN_U_51, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\DP MODEL\\rev_HN_U51Overlap_DPmodel_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=TRUE )  
...
cl = makeCluster(19)
registerDoParallel(cl)
DPresults1U_U_26 <- list()

DPresults1U_U_26 = foreach(i = 1:N.sim,.packages = c("rjags", "R2jags","tidyverse")) %dopar% {
  set.seed(275)
  run.model = jags(
    data =list(ns = nrow(p[[i]]),
               r1 = p[[i]]$ci,
...
DPresultsU_U_26 <- list()
posteriorDPU_U_26 <- list()
postDPU_U_26 <- list()
for(i in 1:N.sim){
  DPresultsU_U_26[[i]] <- as.data.frame(DPresults1U_U_26[[i]]$BUGSoutput$summary) 
  posteriorDPU_U_26[[i]] = as.data.frame(DPresults1U_U_26[[i]]$BUGSoutput$sims.matrix)
  postDPU_U_26[[i]] <- posteriorDPU_U_26[[i]]$poptrue
}

DP_resultsU_U_26 <- list()
for(i in 1:N.sim){
  DP_resultsU_U_26[[i]] <- DPresultsU_U_26[[i]] 
}
...
LB_base_muU_U_26 <- c()
UB_base_muU_U_26 <- c()
LB_base_tau2U_U_26 <- c()
UB_base_tau2U_U_26 <- c()
Rhat_muDPU_U_26 <- c()
Rhat_tau2DPU_U_26 <- c()
Rhat_basemuU_U_26 <- c()
Rhat_basetauU_U_26 <- c()
Rhat_alphaU_U_26 <- c()
Rhat_deltaDPU_U_26 <- list()
median_KU_U_26 <- list()
LB_KU_U_26 <- list()
UB_KU_U_26 <- list()
rel_effDPU_U_26 <- list()
LB_rel_effDPU_U_26 <- list()
UB_rel_effDPU_U_26 <- list()
sd_rel_effDPU_U_26 <- list()
piU_U_26 <- list()
f11U_U_26 <- list()
m11U_U_26 <- list()
f22U_U_26 <- list()
...
mpU_U_26 <- list()
listaDP1U_U_26 <- list()
listaDP_weightsU_U_26 <- list()
for(i in 1:N.sim){
  f11U_U_26[[i]] <- grepl("poptrue", row.names(DP_resultsU_U_26[[i]]))
  m11U_U_26[[i]] <- DP_resultsU_U_26[[i]][f11U_U_26[[i]],]
  mu_DPU_U_26[i] <- m11U_U_26[[i]]$`50%`
  LB_mu_DPU_U_26[i] <- m11U_U_26[[i]]$`2.5%`
  UB_mu_DPU_U_26[i] <- m11U_U_26[[i]]$`97.5%`
  Rhat_muDPU_U_26[i] <- m11U_U_26[[i]]$Rhat
  precDP_muU_U_26[i] <- UB_mu_DPU_U_26[i] - LB_mu_DPU_U_26[i]
  
  f22U_U_26[[i]] <- grepl("var.true", row.names(DP_resultsU_U_26[[i]]))
  m22U_U_26[[i]] <- DP_resultsU_U_26[[i]][f22U_U_26[[i]],]
  tau2_DPU_U_26[i] <- m22U_U_26[[i]]$`50%`
  LB_tau2_DPU_U_26[i] <- m22U_U_26[[i]]$`2.5%`
  UB_tau2_DPU_U_26[i] <- m22U_U_26[[i]]$`97.5%`
  Rhat_tau2DPU_U_26[i] <- m22U_U_26[[i]]$Rhat
  precDP_tau2U_U_26[i] <- UB_tau2_DPU_U_26[i] -  LB_tau2_DPU_U_26[i]
  
  fddU_U_26[[i]] <- grepl("delta12", row.names(DP_resultsU_U_26[[i]]))
  mddU_U_26[[i]] <- DP_resultsU_U_26[[i]][fddU_U_26[[i]],]
  rel_effDPU_U_26[[i]] <- mddU_U_26[[i]]$`50%`
  LB_rel_effDPU_U_26[[i]] <- mddU_U_26[[i]]$`2.5%`
  UB_rel_effDPU_U_26[[i]] <- mddU_U_26[[i]]$`97.5%`
  sd_rel_effDPU_U_26[[i]] <- mddU_U_26[[i]]$sd
  Rhat_deltaDPU_U_26[[i]] <- mddU_U_26[[i]]$Rhat
  
  f33U_U_26[[i]] <- grepl("basemu", row.names(DP_resultsU_U_26[[i]]))
  m33U_U_26[[i]] <- DP_resultsU_U_26[[i]][f33U_U_26[[i]],]
  base_muU_U_26[i] <- m33U_U_26[[i]]$`50%`
  LB_base_muU_U_26[i] <- m33U_U_26[[i]]$`2.5%`
  UB_base_muU_U_26[i] <- m33U_U_26[[i]]$`97.5%`
  Rhat_basemuU_U_26[i] <- m33U_U_26[[i]]$Rhat
  prec_basemuU_U_26[i] <- UB_base_muU_U_26[i] - LB_base_muU_U_26[i]
  
  f44U_U_26[[i]] <- grepl("basetau", row.names(DP_resultsU_U_26[[i]]))
  m44U_U_26[[i]] <- DP_resultsU_U_26[[i]][f44U_U_26[[i]],]
  base_tauU_U_26[i] <- m44U_U_26[[i]]$`50%`
  base_tau2U_U_26[i] <- (m44U_U_26[[i]]$`50%`)^2
  LB_base_tau2U_U_26[i] <- (m44U_U_26[[i]]$`2.5%`)^2
  UB_base_tau2U_U_26[i] <- (m44U_U_26[[i]]$`97.5%`)^2
  Rhat_basetauU_U_26[i] <- (m44U_U_26[[i]]$Rhat)^2
  prec_basetau2U_U_26[i] <- UB_base_tau2U_U_26[i] - LB_base_tau2U_U_26[i]
  
  f55U_U_26[[i]] <- grepl("alpha", row.names(DP_resultsU_U_26[[i]]))
  m55U_U_26[[i]] <- DP_resultsU_U_26[[i]][f55U_U_26[[i]],]
  alphaU_U_26[i] <- m55U_U_26[[i]]$`50%`
  LB_alphaU_U_26[i] <- m55U_U_26[[i]]$`2.5%`
  UB_alphaU_U_26[i] <- m55U_U_26[[i]]$`97.5%`
  Rhat_alphaU_U_26[i] <- m55U_U_26[[i]]$Rhat
  prec_alphaU_U_26[i] <- UB_alphaU_U_26[i] - LB_alphaU_U_26[i]
  
  fclU_U_26[[i]] <- grepl("K", row.names(DP_resultsU_U_26[[i]]))  
  mclU_U_26[[i]] <- DP_resultsU_U_26[[i]][fclU_U_26[[i]],]
  median_KU_U_26[[i]] <- mclU_U_26[[i]]$`50%` 
  LB_KU_U_26[[i]] <- mclU_U_26[[i]]$`2.5%`
  UB_KU_U_26[[i]] <- mclU_U_26[[i]]$`97.5%`
  
  fpU_U_26[[i]] <- grepl("p", row.names(DP_resultsU_U_26[[i]]))
  mpU_U_26[[i]] <- DP_resultsU_U_26[[i]][fpU_U_26[[i]],]
  mpU_U_26[[i]] <- mpU_U_26[[i]][!grepl("pop", row.names(mpU_U_26[[i]])),]
  mpU_U_26[[i]] <- mpU_U_26[[i]][!grepl("alpha", row.names(mpU_U_26[[i]])),]
  piU_U_26[[i]] <- mpU_U_26[[i]]$mean
  
  listaDP1U_U_26[[i]] <- cbind.data.frame(rel_effDPU_U_26[[i]],sd_rel_effDPU_U_26[[i]], LB_rel_effDPU_U_26[[i]],UB_rel_effDPU_U_26[[i]],Rhat_deltaDPU_U_26[[i]])
  listaDP_weightsU_U_26[[i]] <- cbind.data.frame(piU_U_26[[i]])
  
}

numclusU_U_26 <- unlist(median_KU_U_26)
LB_KU_U_26 <- unlist(LB_KU_U_26)
UB_KU_U_26 <- unlist(UB_KU_U_26)

mean_alphaU_U_26 = mean(alphaU_U_26)
mean_alpha_LBU_U_26 = mean(LB_alphaU_U_26)
mean_alpha_UBU_U_26 = mean(UB_alphaU_U_26)

tau_DPU_U_26 = sqrt(tau2_DPU_U_26)
LB_tau_DPU_U_26 = sqrt(LB_tau2_DPU_U_26)
UB_tau_DPU_U_26 = sqrt(UB_tau2_DPU_U_26)
precDP_tauU_U_26 = UB_tau_DPU_U_26 -  LB_tau_DPU_U_26


RhatsDPU_U_26 <- cbind.data.frame(base_muU_U_26,LB_base_muU_U_26,UB_base_muU_U_26,base_tauU_U_26,base_tau2U_U_26, LB_base_tau2U_U_26,UB_base_tau2U_U_26,
                                  mu_DPU_U_26, LB_mu_DPU_U_26, UB_mu_DPU_U_26, tau2_DPU_U_26, LB_tau2_DPU_U_26, UB_tau2_DPU_U_26,
                                  tau_DPU_U_26, LB_tau_DPU_U_26, UB_tau_DPU_U_26,
                                  precDP_muU_U_26, precDP_tau2U_U_26, prec_basemuU_U_26, prec_basetau2U_U_26,prec_alphaU_U_26,  alphaU_U_26 , LB_alphaU_U_26, UB_alphaU_U_26,
                                  mean_alphaU_U_26, mean_alpha_LBU_U_26, mean_alpha_UBU_U_26,
                                  Rhat_muDPU_U_26, Rhat_tau2DPU_U_26, Rhat_basemuU_U_26, Rhat_basetauU_U_26, Rhat_alphaU_U_26, numclusU_U_26, LB_KU_U_26, UB_KU_U_26)

##########REMOVE Rhats > 1.05 ##############

condition1U_U_26 <- which(RhatsDPU_U_26$Rhat_muDPU_U_26 > 1.05)
condition2U_U_26 <- which(RhatsDPU_U_26$Rhat_tau2DPU_U_26 > 1.05)
condition3U_U_26 <- which(RhatsDPU_U_26$Rhat_basemuU_U_26 > 1.05)
condition4U_U_26 <- which(RhatsDPU_U_26$Rhat_basetauU_U_26 > 1.05)
condition5U_U_26 <- which(RhatsDPU_U_26$Rhat_alphaU_U_26 > 1.05)


dist.condDPU_U_26 = c(condition1U_U_26,condition2U_U_26,condition3U_U_26,condition4U_U_26,condition5U_U_26)
dist.condDPU_U_26 = unique(dist.condDPU_U_26)

RhatDP_outU_U_26 = round((length(dist.condDPU_U_26)/N.sim), 4)

############### Extract and remove the datasets with Rhat > 1.05 #########
if (length(dist.condDPU_U_26)== 0) {
  RhatsDPU_U_26 <- RhatsDPU_U_26
  listaDPU_U_26 <- listaDP1U_U_26
  listaDP_weightsU_U_26 <- listaDP_weightsU_U_26
  N.sim <- nrow(RhatsDPU_U_26)
  pDPU_U_26 <- p
  
} else {
  RhatsDPU_U_26 <- RhatsDPU_U_26[-dist.condDPU_U_26, ]
  listaDPU_U_26 <- listaDP1U_U_26[-dist.condDPU_U_26]
  listaDP_weightsU_U_26 <- listaDP_weightsU_U_26[-dist.condDPU_U_26]
  N.sim <- nrow(RhatsDPU_U_26)
  pDPU_U_26 <- p[-dist.condDPU_U_26]
}

count_DPU_U_26 = list()
for(i in length(listaDPU_U_26)){
  count_DPU_U_26[[i]] = which(listaDPU_U_26[[i]]$`Rhat_deltaDPU_U_26[[i]]` > 1.05 )
  tell_meDPU_U_26 = which(count_DPU_U_26[[i]] != 0)
}

tell_meDPU_U_26

if(length(tell_meDPU_U_26) == 0){
  RhatsDPU_U_26 <- RhatsDPU_U_26
  N.sim <- nrow(RhatsDPU_U_26)
  listaDPU_U_26 <- listaDPU_U_26
  listaDP_weightsU_U_26 <- listaDP_weightsU_U_26
  pDPU_U_26 <- pDPU_U_26
  RhatDP_outU_U_26 <- RhatDP_outU_U_26
} else {
  RhatsDPU_U_26 <- RhatsDPU_U_26[-tell_meDPU_U_26, ]
  listaDPU_U_26 <- listaDPU_U_26[-tell_meDPU_U_26]
  listaDP_weightsU_U_26 <- listaDP_weightsU_U_26[-tell_meDPU_U_26]
  N.sim = nrow(RhatsDPU_U_26)
  pDPU_U_26 <- pDPU_U_26[-tell_meDPU_U_26]
  RhatDP_outU_U_26 <- RhatDP_outU_U_26 + ((length(tell_meDPU_U_26))/N.sim)
}

RhatDP_outU_U_26

#### AVERAGE ABSOLUTE BIAS OF mu ######
abs_biasDPjags.binU_U_26 <- c()
for (i in 1:N.sim){
  abs_biasDPjags.binU_U_26[i] <- abs( RhatsDPU_U_26$mu_DPU_U_26[i] - mu) 
}
avg_abs_biasDPjags.binU_U_26 <- round(mean(abs_biasDPjags.binU_U_26),2)

#### AVERAGE DIFFERENCES OF mu ######
rel_biasDPjags.binU_U_26 <- c()
for (i in 1:N.sim){
  rel_biasDPjags.binU_U_26[i] <- ( RhatsDPU_U_26$mu_DPU_U_26[i] - mu) 
}
avg_rel_biasDPjags.binU_U_26 <- round(mean(rel_biasDPjags.binU_U_26),2)

######  MSE OF mu ##########
MSE_DPjags.binU_U_26 <- c()
for (i in 1:N.sim){
  MSE_DPjags.binU_U_26[i] <- RMSE(estimate = RhatsDPU_U_26$mu_DPU_U_26[i],
                                  parameter = mu,
                                  type = "RMSE",
                                  MSE = TRUE )        
}
avg_MSE_DPjags.binU_U_26 <- round(mean(MSE_DPjags.binU_U_26), 4)

############ COVERAGE OF mu ########
interval_contains_true_mean <- function(i) { 
  ( mu >= RhatsDPU_U_26$LB_mu_DPU_U_26[i]) && ( mu <= RhatsDPU_U_26$UB_mu_DPU_U_26[i])
}
interval_contains_true_mean(i)

coverageDPjags.binU_U_26 <- c()
for (i in 1:N.sim){
  if (interval_contains_true_mean(i) == TRUE){
    coverageDPjags.binU_U_26[i] = 1
  }
  else {
    coverageDPjags.binU_U_26[i]=0
  }
  print(coverageDPjags.binU_U_26[i])
}
coverageDPjags.binU_U_26
coverDPjags.binU_U_26 <- round(mean(coverageDPjags.binU_U_26)*100, 2)

## BIAS OF base_mu ######
biasDPjags_basemu.binU_U_26 <- c()
for (i in 1:N.sim){
  biasDPjags_basemu.binU_U_26[i] <- abs( RhatsDPU_U_26$base_muU_U_26[i] - mu) 
}
avg_biasDPjags_basemu.binU_U_26 <- round(mean(biasDPjags_basemu.binU_U_26),2)

###### MSE OF base_mu ##########
MSE_DPjags_basemu.binU_U_26 <- c()
for (i in 1:N.sim){
  MSE_DPjags_basemu.binU_U_26[i] <- RMSE(estimate =RhatsDPU_U_26$base_muU_U_26[i],
                                         parameter = mu,
                                         type = "RMSE",
                                         MSE = TRUE      
  )
}
avg_MSE_DPjags_basemu.binU_U_26 <- round(mean(MSE_DPjags_basemu.binU_U_26), 4)

############ COVERAGE OF base_mu ########
interval_contains_true_mean <- function(i) { 
  ( mu >= RhatsDPU_U_26$LB_base_muU_U_26[i]) && ( mu <= RhatsDPU_U_26$UB_base_muU_U_26[i])
}
interval_contains_true_mean(i)

coverageDPjags_basemu.binU_U_26 <- c()
for (i in 1:N.sim){
  if (interval_contains_true_mean(i) == TRUE){
    coverageDPjags_basemu.binU_U_26[i] = 1
  }
  else {
    coverageDPjags_basemu.binU_U_26[i]=0
  }
  print(coverageDPjags_basemu.binU_U_26[i])
}
coverageDPjags_basemu.binU_U_26
coverDPjags_basemu.binU_U_26 <- round(mean(coverageDPjags_basemu.binU_U_26)*100, 2)

######## AVERAGE BIAS OF tau2 ###########
bias_tau2DPjags.binU_U_26 <- c()
for (i in 1:N.sim){
  bias_tau2DPjags.binU_U_26[i] <- abs(RhatsDPU_U_26$tau2_DPU_U_26[i]- tau2)
}
avg_bias_tau2DPjags.binU_U_26 <- round(mean(bias_tau2DPjags.binU_U_26),2)

pbias_tau2DPjags.binU_U_26 <- round(mean(bias_tau2DPjags.binU_U_26 / tau2),2)

######## MSE OF tau2 #############
MSE_DPjags.bin.tau2U_U_26 <- c()
for (i in 1:N.sim){
  MSE_DPjags.bin.tau2U_U_26[i] <- RMSE(estimate =RhatsDPU_U_26$tau2_DPU_U_26[i],
                                       parameter = tau2,
                                       type = "RMSE",
                                       MSE = TRUE         
  )
...
avg_MSE_DPjags.bin.tau2U_U_26 <- round(mean(MSE_DPjags.bin.tau2U_U_26),4)

nMSE_DPjags.bin.tau2U_U_26 <- round(mean(MSE_DPjags.bin.tau2U_U_26/ (tau2)^2),4)

############ COVERAGE OF tau2 ##################
interval_contains_true_mean <- function(i) { 
  ( tau2 >= RhatsDPU_U_26$LB_tau2_DPU_U_26[i]) && ( tau2 <= RhatsDPU_U_26$UB_tau2_DPU_U_26[i])
}
interval_contains_true_mean(i)

coverage_tau2DPjags.binU_U_26 <- c()
for (i in 1:N.sim){
  if (interval_contains_true_mean(i) == TRUE){
    coverage_tau2DPjags.binU_U_26[i] = 1
  }
  else  {
    coverage_tau2DPjags.binU_U_26[i] = 0
  }
  print(coverage_tau2DPjags.binU_U_26[i])
}
coverage_tau2DPjags.binU_U_26
cover_tau2DPjags.binU_U_26 <- round(mean(coverage_tau2DPjags.binU_U_26)*100, 2)


######## PERCENT RELATIVE BIAS OF tau ###########
rel_bias_tauDPjags.binU_U_26 <- c()
for (i in 1:N.sim){
  rel_bias_tauDPjags.binU_U_26[i] <- (RhatsDPU_U_26$tau_DPU_U_26[i]- tau)
}
avg_rel_bias_tauDPjags.binU_U_26 <- round(mean(rel_bias_tauDPjags.binU_U_26),2)

prel_bias_tauDPjags.binU_U_26 <- round(mean(rel_bias_tauDPjags.binU_U_26 / tau)*100,2)

######## AVERAGE ABSOLUTE  BIAS OF tau ###########
abs_bias_tauDPjags.binU_U_26 <- c()
for (i in 1:N.sim){
  abs_bias_tauDPjags.binU_U_26[i] <- abs(RhatsDPU_U_26$tau_DPU_U_26[i]- tau)
}
avg_abs_bias_tauDPjags.binU_U_26 <- round(mean(abs_bias_tauDPjags.binU_U_26),2)

pabs_bias_tauDPjags.binU_U_26 <- round(mean(abs_bias_tauDPjags.binU_U_26 / tau)*100,2)

######## MSE OF tau #############
MSE_DPjags.bin.tauU_U_26 <- c()
for (i in 1:N.sim){
  MSE_DPjags.bin.tauU_U_26[i] <- RMSE(estimate =RhatsDPU_U_26$tau_DPU_U_26[i],
                                      parameter = tau,
                                      type = "RMSE",
                                      MSE = TRUE         
  )
...
avg_MSE_DPjags.bin.tauU_U_26 <- round(mean(MSE_DPjags.bin.tauU_U_26),4)

nMSE_DPjags.bin.tauU_U_26 <- round(mean(MSE_DPjags.bin.tauU_U_26/ tau2),4)

############ COVERAGE OF tau ##################
interval_contains_true_mean <- function(i) { 
  ( tau >= RhatsDPU_U_26$LB_tau_DPU_U_26[i]) && ( tau <= RhatsDPU_U_26$UB_tau_DPU_U_26[i])
}
interval_contains_true_mean(i)

coverage_tauDPjags.binU_U_26 <- c()
for (i in 1:N.sim){
  if (interval_contains_true_mean(i) == TRUE){
    coverage_tauDPjags.binU_U_26[i] = 1
  }
  else  {
    coverage_tauDPjags.binU_U_26[i] = 0
  }
  print(coverage_tauDPjags.binU_U_26[i])
}
coverage_tauDPjags.binU_U_26
cover_tauDPjags.binU_U_26 <- round(mean(coverage_tauDPjags.binU_U_26)*100, 2)


######## AVERAGE BIAS OF base_tau2 ###########
bias_basetau2DPjags.binU_U_26 <- c()
for (i in 1:N.sim){
  bias_basetau2DPjags.binU_U_26[i] <- abs(RhatsDPU_U_26$base_tau2U_U_26[i]- tau2)
}
avg_bias_basetau2DPjags.binU_U_26 <- round(mean(bias_basetau2DPjags.binU_U_26),2)

######## MSE OF base_tau2 #############
MSE_DPjags.bin.basetau2U_U_26 <- c()
for (i in 1:N.sim){
  MSE_DPjags.bin.basetau2U_U_26[i] <- RMSE(estimate =RhatsDPU_U_26$base_tau2U_U_26[i],
                                           parameter = tau2,
                                           type = "RMSE",
                                           MSE = TRUE         
  )
...
avg_MSE_DPjags.bin.basetau2U_U_26 <- round(mean(MSE_DPjags.bin.basetau2U_U_26),4)

############ COVERAGE OF base_tau2 ##################
interval_contains_true_mean <- function(i) {
  ( tau2 >= RhatsDPU_U_26$LB_base_tau2U_U_26[i]) && ( tau2 <= RhatsDPU_U_26$UB_base_tau2U_U_26[i])
}
interval_contains_true_mean(i)

coverage_basetau2DPjags.binU_U_26 <- c()
for (i in 1:N.sim){
  if (interval_contains_true_mean(i) == TRUE){
    coverage_basetau2DPjags.binU_U_26[i] = 1
  }
  else  {
    coverage_basetau2DPjags.binU_U_26[i] = 0
  }
  print(coverage_basetau2DPjags.binU_U_26[i])
}
coverage_basetau2DPjags.binU_U_26
cover_basetau2DPjags.binU_U_26 <- round(mean(coverage_basetau2DPjags.binU_U_26)*100, 2)

######################## ABSOLUTE BIAS OF RELATIVE EFFECTS ##################
abs_bias_relDPU_U_26 <- list()
mean_abs_bias_relDPU_U_26 <- list()
for(i in 1:N.sim){
  for(j in 1:nrow(pDPU_U_26[[i]])){
    abs_bias_relDPU_U_26[[i]] <- round(abs(listaDPU_U_26[[i]]$`rel_effDPU_U_26[[i]]` - pDPU_U_26[[i]]$true_eff ),2)
    mean_abs_bias_relDPU_U_26[[i]] <- mean(abs_bias_relDPU_U_26[[i]])
  }
}
#mean_bias_relDP

################## mean bias of the mean biases of each data set for relative effects  ###################
mean_abs_bias_of_mean_abs_bias_relDPU_U_26 <- unlist(mean_abs_bias_relDPU_U_26)
mean_abs_bias_of_mean_abs_bias_relDPU_U_26  <- round(mean(mean_abs_bias_of_mean_abs_bias_relDPU_U_26),2)

######################## AVERAGE DIFFERENCES OF RELATIVE EFFECTS ##################
rel_bias_relDPU_U_26 <- list()
mean_rel_bias_relDPU_U_26 <- list()
for(i in 1:N.sim){
  for(j in 1:nrow(pDPU_U_26[[i]])){
    rel_bias_relDPU_U_26[[i]] <- round((listaDPU_U_26[[i]]$`rel_effDPU_U_26[[i]]` - pDPU_U_26[[i]]$true_eff ),2)
    mean_rel_bias_relDPU_U_26[[i]] <- mean(rel_bias_relDPU_U_26[[i]])
  }
}
#mean_bias_relDP

################## mean bias of the mean biases of each data set for relative effects  ###################
mean_rel_bias_of_mean_rel_bias_relDPU_U_26 <- unlist(mean_rel_bias_relDPU_U_26)
mean_rel_bias_of_mean_rel_bias_relDPU_U_26  <- round(mean(mean_rel_bias_of_mean_rel_bias_relDPU_U_26),2)

#####
########################### FOR THE OVERLAPPING ######################
dataDPU_U_26 <- list()
overlapDP1U_U_26 <- list()
overlapDPU_U_26 <- list()
for(i in 1:N.sim){
  dataDPU_U_26[[i]] <- list(DP = listaDPU_U_26[[i]]$`rel_effDPU_U_26[[i]]` , True = pDPU_U_26[[i]]$true_eff  )
  overlapDP1U_U_26[[i]] <- overlap(dataDPU_U_26[[i]], type = "2")
  overlapDPU_U_26[[i]] <- overlapDP1U_U_26[[i]]$OV
}
overlapDPU_U_26 <- unlist(overlapDPU_U_26)
avg_overlapDPU_U_26 <- round(mean(overlapDPU_U_26),2)


listaDP_rel_effU_U_26 <- cbind( mean_abs_bias_relDPU_U_26, mean_abs_bias_of_mean_abs_bias_relDPU_U_26,
                                mean_rel_bias_relDPU_U_26, mean_rel_bias_of_mean_rel_bias_relDPU_U_26) 

######### SAVE THE OUTPUTS ###########
DP_bin_jagsU_U_26 <- cbind(RhatsDPU_U_26,
                           abs_biasDPjags.binU_U_26, rel_biasDPjags.binU_U_26,
                           MSE_DPjags.binU_U_26, biasDPjags_basemu.binU_U_26, MSE_DPjags_basemu.binU_U_26,
                           bias_tau2DPjags.binU_U_26,rel_bias_tauDPjags.binU_U_26, abs_bias_tauDPjags.binU_U_26, 
                           MSE_DPjags.bin.tau2U_U_26, MSE_DPjags.bin.tauU_U_26,
                           bias_basetau2DPjags.binU_U_26, MSE_DPjags.bin.basetau2U_U_26, 
                           avg_abs_biasDPjags.binU_U_26, avg_rel_biasDPjags.binU_U_26, 
                           avg_biasDPjags_basemu.binU_U_26, 
                           avg_bias_tau2DPjags.binU_U_26,pbias_tau2DPjags.binU_U_26,avg_rel_bias_tauDPjags.binU_U_26,avg_abs_bias_tauDPjags.binU_U_26,
                           prel_bias_tauDPjags.binU_U_26,pabs_bias_tauDPjags.binU_U_26,
                           avg_bias_basetau2DPjags.binU_U_26,
                           rel_bias_tauDPjags.binU_U_26,abs_bias_tauDPjags.binU_U_26,
                           avg_MSE_DPjags.binU_U_26,avg_MSE_DPjags_basemu.binU_U_26,avg_MSE_DPjags.bin.tau2U_U_26, nMSE_DPjags.bin.tau2U_U_26,
                           avg_MSE_DPjags.bin.tauU_U_26, nMSE_DPjags.bin.tauU_U_26,
                           avg_MSE_DPjags.bin.basetau2U_U_26,
                           coverageDPjags.binU_U_26 , coverageDPjags_basemu.binU_U_26, coverage_tau2DPjags.binU_U_26, coverage_basetau2DPjags.binU_U_26, 
                           coverage_tauDPjags.binU_U_26, 
                           coverDPjags.binU_U_26, coverDPjags_basemu.binU_U_26, cover_tau2DPjags.binU_U_26, cover_tauDPjags.binU_U_26,
                           cover_basetau2DPjags.binU_U_26, RhatDP_outU_U_26)

Overlap_DPmodelU_U_26 <- cbind(overlapDPU_U_26, avg_overlapDPU_U_26)                    

write.csv(DP_bin_jagsU_U_26, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\DP MODEL\\rev_UNIF_UNIF26_ResultsDP_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
write.csv(listaDPU_U_26, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\DP MODEL\\rev_UNIF_UNIF26_Relative_eff_ResultsDP_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
write.csv(listaDP_rel_effU_U_26, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\DP MODEL\\rev_UNIF_UNIF26_Bias_Relative_eff_ResultsDP_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
write.csv(Overlap_DPmodelU_U_26,"C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\DP MODEL\\rev_UNIF_UNIF26_Overlap_DPmodel_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=TRUE ) 
write.csv(listaDP_weightsU_U_26,"C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\DP MODEL\\rev_UNIF_UNIF26_Weights_in_clusters_jags_DP_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=TRUE ) 
...
write.csv(DP_bin_jags_U_G_n, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\DP MODEL\\rev_UNIF_gamma_ns_ResultsDP_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
write.csv(listaDP_U_G_n, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\DP MODEL\\rev_UNIF_gamma_ns_Relative_eff_ResultsDP_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
write.csv(listaDP_rel_eff_U_G_n, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\DP MODEL\\rev_UNIF_gamma_ns_Bias_Relative_eff_ResultsDP_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
write.csv(Overlap_DPmodel_U_G_n,"C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\DP MODEL\\rev_UNIF_gamma_ns_Overlap_DPmodel_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=TRUE ) 
write.csv(listaDP_weights_U_G_n,"C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\DP MODEL\\rev_UNIF_gamma_ns_Weights_in_clusters_jags_DP_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=TRUE ) 
...
cl = makeCluster(19)
registerDoParallel(cl)
DPresults1U_U_51 <- list()

DPresults1U_U_51 = foreach(i = 1:N.sim,.packages = c("rjags", "R2jags","tidyverse")) %dopar% {
  set.seed(277)
  run.model = jags(
    data =list(ns = nrow(p[[i]]),
               r1 = p[[i]]$ci,
...
DPresultsU_U_51 <- list()
posteriorDPU_U_51 <- list()
postDPU_U_51 <- list()
for(i in 1:N.sim){
  DPresultsU_U_51[[i]] <- as.data.frame(DPresults1U_U_51[[i]]$BUGSoutput$summary) 
  posteriorDPU_U_51[[i]] = as.data.frame(DPresults1U_U_51[[i]]$BUGSoutput$sims.matrix)
  postDPU_U_51[[i]] <- posteriorDPU_U_51[[i]]$poptrue
}

DP_resultsU_U_51 <- list()
for(i in 1:N.sim){
  DP_resultsU_U_51[[i]] <- DPresultsU_U_51[[i]] 
}
...
LB_base_muU_U_51 <- c()
UB_base_muU_U_51 <- c()
LB_base_tau2U_U_51 <- c()
UB_base_tau2U_U_51 <- c()
Rhat_muDPU_U_51 <- c()
Rhat_tau2DPU_U_51 <- c()
Rhat_basemuU_U_51 <- c()
Rhat_basetauU_U_51 <- c()
Rhat_alphaU_U_51 <- c()
Rhat_deltaDPU_U_51 <- list()
median_KU_U_51 <- list()
LB_KU_U_51 <- list()
UB_KU_U_51 <- list()
rel_effDPU_U_51 <- list()
LB_rel_effDPU_U_51 <- list()
UB_rel_effDPU_U_51 <- list()
sd_rel_effDPU_U_51 <- list()
piU_U_51 <- list()
f11U_U_51 <- list()
m11U_U_51 <- list()
f22U_U_51 <- list()
...
mpU_U_51 <- list()
listaDP1U_U_51 <- list()
listaDP_weightsU_U_51 <- list()
for(i in 1:N.sim){
  f11U_U_51[[i]] <- grepl("poptrue", row.names(DP_resultsU_U_51[[i]]))
  m11U_U_51[[i]] <- DP_resultsU_U_51[[i]][f11U_U_51[[i]],]
  mu_DPU_U_51[i] <- m11U_U_51[[i]]$`50%`
  LB_mu_DPU_U_51[i] <- m11U_U_51[[i]]$`2.5%`
  UB_mu_DPU_U_51[i] <- m11U_U_51[[i]]$`97.5%`
  Rhat_muDPU_U_51[i] <- m11U_U_51[[i]]$Rhat
  precDP_muU_U_51[i] <- UB_mu_DPU_U_51[i] - LB_mu_DPU_U_51[i]
  
  f22U_U_51[[i]] <- grepl("var.true", row.names(DP_resultsU_U_51[[i]]))
  m22U_U_51[[i]] <- DP_resultsU_U_51[[i]][f22U_U_51[[i]],]
  tau2_DPU_U_51[i] <- m22U_U_51[[i]]$`50%`
  LB_tau2_DPU_U_51[i] <- m22U_U_51[[i]]$`2.5%`
  UB_tau2_DPU_U_51[i] <- m22U_U_51[[i]]$`97.5%`
  Rhat_tau2DPU_U_51[i] <- m22U_U_51[[i]]$Rhat
  precDP_tau2U_U_51[i] <- UB_tau2_DPU_U_51[i] -  LB_tau2_DPU_U_51[i]
  
  fddU_U_51[[i]] <- grepl("delta12", row.names(DP_resultsU_U_51[[i]]))
  mddU_U_51[[i]] <- DP_resultsU_U_51[[i]][fddU_U_51[[i]],]
  rel_effDPU_U_51[[i]] <- mddU_U_51[[i]]$`50%`
  LB_rel_effDPU_U_51[[i]] <- mddU_U_51[[i]]$`2.5%`
  UB_rel_effDPU_U_51[[i]] <- mddU_U_51[[i]]$`97.5%`
  sd_rel_effDPU_U_51[[i]] <- mddU_U_51[[i]]$sd
  Rhat_deltaDPU_U_51[[i]] <- mddU_U_51[[i]]$Rhat
  
  f33U_U_51[[i]] <- grepl("basemu", row.names(DP_resultsU_U_51[[i]]))
  m33U_U_51[[i]] <- DP_resultsU_U_51[[i]][f33U_U_51[[i]],]
  base_muU_U_51[i] <- m33U_U_51[[i]]$`50%`
  LB_base_muU_U_51[i] <- m33U_U_51[[i]]$`2.5%`
  UB_base_muU_U_51[i] <- m33U_U_51[[i]]$`97.5%`
  Rhat_basemuU_U_51[i] <- m33U_U_51[[i]]$Rhat
  prec_basemuU_U_51[i] <- UB_base_muU_U_51[i] - LB_base_muU_U_51[i]
  
  f44U_U_51[[i]] <- grepl("basetau", row.names(DP_resultsU_U_51[[i]]))
  m44U_U_51[[i]] <- DP_resultsU_U_51[[i]][f44U_U_51[[i]],]
  base_tauU_U_51[i] <- m44U_U_51[[i]]$`50%`
  base_tau2U_U_51[i] <- (m44U_U_51[[i]]$`50%`)^2
  LB_base_tau2U_U_51[i] <- (m44U_U_51[[i]]$`2.5%`)^2
  UB_base_tau2U_U_51[i] <- (m44U_U_51[[i]]$`97.5%`)^2
  Rhat_basetauU_U_51[i] <- (m44U_U_51[[i]]$Rhat)^2
  prec_basetau2U_U_51[i] <- UB_base_tau2U_U_51[i] - LB_base_tau2U_U_51[i]
  
  f55U_U_51[[i]] <- grepl("alpha", row.names(DP_resultsU_U_51[[i]]))
  m55U_U_51[[i]] <- DP_resultsU_U_51[[i]][f55U_U_51[[i]],]
  alphaU_U_51[i] <- m55U_U_51[[i]]$`50%`
  LB_alphaU_U_51[i] <- m55U_U_51[[i]]$`2.5%`
  UB_alphaU_U_51[i] <- m55U_U_51[[i]]$`97.5%`
  Rhat_alphaU_U_51[i] <- m55U_U_51[[i]]$Rhat
  prec_alphaU_U_51[i] <- UB_alphaU_U_51[i] - LB_alphaU_U_51[i]
  
  fclU_U_51[[i]] <- grepl("K", row.names(DP_resultsU_U_51[[i]]))  
  mclU_U_51[[i]] <- DP_resultsU_U_51[[i]][fclU_U_51[[i]],]
  median_KU_U_51[[i]] <- mclU_U_51[[i]]$`50%` 
  LB_KU_U_51[[i]] <- mclU_U_51[[i]]$`2.5%`
  UB_KU_U_51[[i]] <- mclU_U_51[[i]]$`97.5%`
  
  fpU_U_51[[i]] <- grepl("p", row.names(DP_resultsU_U_51[[i]]))
  mpU_U_51[[i]] <- DP_resultsU_U_51[[i]][fpU_U_51[[i]],]
  mpU_U_51[[i]] <- mpU_U_51[[i]][!grepl("pop", row.names(mpU_U_51[[i]])),]
  mpU_U_51[[i]] <- mpU_U_51[[i]][!grepl("alpha", row.names(mpU_U_51[[i]])),]
  piU_U_51[[i]] <- mpU_U_51[[i]]$mean
  
  listaDP1U_U_51[[i]] <- cbind.data.frame(rel_effDPU_U_51[[i]],sd_rel_effDPU_U_51[[i]], LB_rel_effDPU_U_51[[i]],UB_rel_effDPU_U_51[[i]],Rhat_deltaDPU_U_51[[i]])
  listaDP_weightsU_U_51[[i]] <- cbind.data.frame(piU_U_51[[i]])
...
mean_alphaU_U_51 = mean(alphaU_U_51)
mean_alpha_LBU_U_51 = mean(LB_alphaU_U_51)
mean_alpha_UBU_U_51 = mean(UB_alphaU_U_51)
...
RhatsDPU_U_51 <- cbind.data.frame(base_muU_U_51,LB_base_muU_U_51,UB_base_muU_U_51,base_tauU_U_51,base_tau2U_U_51, LB_base_tau2U_U_51,UB_base_tau2U_U_51,
                                  ...
                                  precDP_muU_U_51, precDP_tau2U_U_51, prec_basemuU_U_51, prec_basetau2U_U_51,prec_alphaU_U_51,  alphaU_U_51 , LB_alphaU_U_51, UB_alphaU_U_51,
                                  mean_alphaU_U_51, mean_alpha_LBU_U_51, mean_alpha_UBU_U_51,
                                  Rhat_muDPU_U_51, Rhat_tau2DPU_U_51, Rhat_basemuU_U_51, Rhat_basetauU_U_51, Rhat_alphaU_U_51, numclusU_U_51, LB_KU_U_51, UB_KU_U_51)

##########REMOVE Rhats > 1.05 ##############

condition1U_U_51 <- which(RhatsDPU_U_51$Rhat_muDPU_U_51 > 1.05)
condition2U_U_51 <- which(RhatsDPU_U_51$Rhat_tau2DPU_U_51 > 1.05)
condition3U_U_51 <- which(RhatsDPU_U_51$Rhat_basemuU_U_51 > 1.05)
condition4U_U_51 <- which(RhatsDPU_U_51$Rhat_basetauU_U_51 > 1.05)
condition5U_U_51 <- which(RhatsDPU_U_51$Rhat_alphaU_U_51 > 1.05)


dist.condDPU_U_51 = c(condition1U_U_51,condition2U_U_51,condition3U_U_51,condition4U_U_51,condition5U_U_51)
dist.condDPU_U_51 = unique(dist.condDPU_U_51)

RhatDP_outU_U_51 = round((length(dist.condDPU_U_51)/N.sim), 4)

############### Extract and remove the datasets with Rhat > 1.05 #########
if (length(dist.condDPU_U_51)== 0) {
  RhatsDPU_U_51 <- RhatsDPU_U_51
  listaDPU_U_51 <- listaDP1U_U_51
  listaDP_weightsU_U_51 <- listaDP_weightsU_U_51
  N.sim <- nrow(RhatsDPU_U_51)
  pDPU_U_51 <- p
  
} else {
  RhatsDPU_U_51 <- RhatsDPU_U_51[-dist.condDPU_U_51, ]
  listaDPU_U_51 <- listaDP1U_U_51[-dist.condDPU_U_51]
  listaDP_weightsU_U_51 <- listaDP_weightsU_U_51[-dist.condDPU_U_51]
  N.sim <- nrow(RhatsDPU_U_51)
  pDPU_U_51 <- p[-dist.condDPU_U_51]
}

count_DPU_U_51 = list()
for(i in length(listaDPU_U_51)){
  count_DPU_U_51[[i]] = which(listaDPU_U_51[[i]]$`Rhat_deltaDPU_U_51[[i]]` > 1.05 )
  tell_meDPU_U_51 = which(count_DPU_U_51[[i]] != 0)
}

tell_meDPU_U_51

if(length(tell_meDPU_U_51) == 0){
  RhatsDPU_U_51 <- RhatsDPU_U_51
  N.sim <- nrow(RhatsDPU_U_51)
  listaDPU_U_51 <- listaDPU_U_51
  listaDP_weightsU_U_51 <- listaDP_weightsU_U_51
  pDPU_U_51 <- pDPU_U_51
  RhatDP_outU_U_51 <- RhatDP_outU_U_51
} else {
  RhatsDPU_U_51 <- RhatsDPU_U_51[-tell_meDPU_U_51, ]
  listaDPU_U_51 <- listaDPU_U_51[-tell_meDPU_U_51]
  listaDP_weightsU_U_51 <- listaDP_weightsU_U_51[-tell_meDPU_U_51]
  N.sim = nrow(RhatsDPU_U_51)
  pDPU_U_51 <- pDPU_U_51[-tell_meDPU_U_51]
  RhatDP_outU_U_51 <- RhatDP_outU_U_51 + ((length(tell_meDPU_U_51))/N.sim)
}

RhatDP_outU_U_51

#### AVERAGE ABSOLUTE BIAS OF mu ######
abs_biasDPjags.binU_U_51 <- c()
for (i in 1:N.sim){
  abs_biasDPjags.binU_U_51[i] <- abs( RhatsDPU_U_51$mu_DPU_U_51[i] - mu) 
}
avg_abs_biasDPjags.binU_U_51 <- round(mean(abs_biasDPjags.binU_U_51),2)

#### AVERAGE DIFFERENCES OF mu ######
rel_biasDPjags.binU_U_51 <- c()
for (i in 1:N.sim){
  rel_biasDPjags.binU_U_51[i] <- ( RhatsDPU_U_51$mu_DPU_U_51[i] - mu) 
}
avg_rel_biasDPjags.binU_U_51 <- round(mean(rel_biasDPjags.binU_U_51),2)

######  MSE OF mu ##########
MSE_DPjags.binU_U_51 <- c()
for (i in 1:N.sim){
  MSE_DPjags.binU_U_51[i] <- RMSE(estimate = RhatsDPU_U_51$mu_DPU_U_51[i],
                                  parameter = mu,
                                  type = "RMSE",
                                  MSE = TRUE )        
}
avg_MSE_DPjags.binU_U_51 <- round(mean(MSE_DPjags.binU_U_51), 4)

############ COVERAGE OF mu ########
interval_contains_true_mean <- function(i) { 
  ( mu >= RhatsDPU_U_51$LB_mu_DPU_U_51[i]) && ( mu <= RhatsDPU_U_51$UB_mu_DPU_U_51[i])
}
interval_contains_true_mean(i)

coverageDPjags.binU_U_51 <- c()
for (i in 1:N.sim){
  if (interval_contains_true_mean(i) == TRUE){
    coverageDPjags.binU_U_51[i] = 1
  }
  else {
    coverageDPjags.binU_U_51[i]=0
  }
  print(coverageDPjags.binU_U_51[i])
}
coverageDPjags.binU_U_51
coverDPjags.binU_U_51 <- round(mean(coverageDPjags.binU_U_51)*100, 2)

## BIAS OF base_mu ######
biasDPjags_basemu.binU_U_51 <- c()
for (i in 1:N.sim){
  biasDPjags_basemu.binU_U_51[i] <- abs( RhatsDPU_U_51$base_muU_U_51[i] - mu) 
}
avg_biasDPjags_basemu.binU_U_51 <- round(mean(biasDPjags_basemu.binU_U_51),2)

###### MSE OF base_mu ##########
MSE_DPjags_basemu.binU_U_51 <- c()
for (i in 1:N.sim){
  MSE_DPjags_basemu.binU_U_51[i] <- RMSE(estimate =RhatsDPU_U_51$base_muU_U_51[i],
                                         parameter = mu,
                                         type = "RMSE",
                                         MSE = TRUE      
  )
}
avg_MSE_DPjags_basemu.binU_U_51 <- round(mean(MSE_DPjags_basemu.binU_U_51), 4)

############ COVERAGE OF base_mu ########
interval_contains_true_mean <- function(i) { 
  ( mu >= RhatsDPU_U_51$LB_base_muU_U_51[i]) && ( mu <= RhatsDPU_U_51$UB_base_muU_U_51[i])
}
interval_contains_true_mean(i)

coverageDPjags_basemu.binU_U_51 <- c()
for (i in 1:N.sim){
  if (interval_contains_true_mean(i) == TRUE){
    coverageDPjags_basemu.binU_U_51[i] = 1
  }
  else {
    coverageDPjags_basemu.binU_U_51[i]=0
  }
  print(coverageDPjags_basemu.binU_U_51[i])
}
coverageDPjags_basemu.binU_U_51
coverDPjags_basemu.binU_U_51 <- round(mean(coverageDPjags_basemu.binU_U_51)*100, 2)

######## AVERAGE BIAS OF tau2 ###########
bias_tau2DPjags.binU_U_51 <- c()
for (i in 1:N.sim){
  bias_tau2DPjags.binU_U_51[i] <- abs(RhatsDPU_U_51$tau2_DPU_U_51[i]- tau2)
}
avg_bias_tau2DPjags.binU_U_51 <- round(mean(bias_tau2DPjags.binU_U_51),2)

pbias_tau2DPjags.binU_U_51 <- round(mean(bias_tau2DPjags.binU_U_51 / tau2),2)

######## MSE OF tau2 #############
MSE_DPjags.bin.tau2U_U_51 <- c()
for (i in 1:N.sim){
  MSE_DPjags.bin.tau2U_U_51[i] <- RMSE(estimate =RhatsDPU_U_51$tau2_DPU_U_51[i],
                                       parameter = tau2,
                                       type = "RMSE",
                                       MSE = TRUE         
  )
...
avg_MSE_DPjags.bin.tau2U_U_51 <- round(mean(MSE_DPjags.bin.tau2U_U_51),4)

nMSE_DPjags.bin.tau2U_U_51 <- round(mean(MSE_DPjags.bin.tau2U_U_51/ (tau2)^2),4)

############ COVERAGE OF tau2 ##################
interval_contains_true_mean <- function(i) { 
  ( tau2 >= RhatsDPU_U_51$LB_tau2_DPU_U_51[i]) && ( tau2 <= RhatsDPU_U_51$UB_tau2_DPU_U_51[i])
}
interval_contains_true_mean(i)

coverage_tau2DPjags.binU_U_51 <- c()
for (i in 1:N.sim){
  if (interval_contains_true_mean(i) == TRUE){
    coverage_tau2DPjags.binU_U_51[i] = 1
  }
  else  {
    coverage_tau2DPjags.binU_U_51[i] = 0
  }
  print(coverage_tau2DPjags.binU_U_51[i])
}
coverage_tau2DPjags.binU_U_51
cover_tau2DPjags.binU_U_51 <- round(mean(coverage_tau2DPjags.binU_U_51)*100, 2)


######## PERCENT RELATIVE BIAS OF tau ###########
rel_bias_tauDPjags.binU_U_51 <- c()
for (i in 1:N.sim){
  rel_bias_tauDPjags.binU_U_51[i] <- (RhatsDPU_U_51$tau_DPU_U_51[i]- tau)
}
avg_rel_bias_tauDPjags.binU_U_51 <- round(mean(rel_bias_tauDPjags.binU_U_51),2)

prel_bias_tauDPjags.binU_U_51 <- round(mean(rel_bias_tauDPjags.binU_U_51 / tau)*100,2)

######## AVERAGE ABSOLUTE  BIAS OF tau ###########
abs_bias_tauDPjags.binU_U_51 <- c()
for (i in 1:N.sim){
  abs_bias_tauDPjags.binU_U_51[i] <- abs(RhatsDPU_U_51$tau_DPU_U_51[i]- tau)
}
avg_abs_bias_tauDPjags.binU_U_51 <- round(mean(abs_bias_tauDPjags.binU_U_51),2)

pabs_bias_tauDPjags.binU_U_51 <- round(mean(abs_bias_tauDPjags.binU_U_51 / tau)*100,2)

######## MSE OF tau #############
MSE_DPjags.bin.tauU_U_51 <- c()
for (i in 1:N.sim){
  MSE_DPjags.bin.tauU_U_51[i] <- RMSE(estimate =RhatsDPU_U_51$tau_DPU_U_51[i],
                                      parameter = tau,
                                      type = "RMSE",
                                      MSE = TRUE         
  )
...
avg_MSE_DPjags.bin.tauU_U_51 <- round(mean(MSE_DPjags.bin.tauU_U_51),4)

nMSE_DPjags.bin.tauU_U_51 <- round(mean(MSE_DPjags.bin.tauU_U_51/ tau2),4)

############ COVERAGE OF tau ##################
interval_contains_true_mean <- function(i) { 
  ( tau >= RhatsDPU_U_51$LB_tau_DPU_U_51[i]) && ( tau <= RhatsDPU_U_51$UB_tau_DPU_U_51[i])
}
interval_contains_true_mean(i)

coverage_tauDPjags.binU_U_51 <- c()
for (i in 1:N.sim){
  if (interval_contains_true_mean(i) == TRUE){
    coverage_tauDPjags.binU_U_51[i] = 1
  }
  else  {
    coverage_tauDPjags.binU_U_51[i] = 0
  }
  print(coverage_tauDPjags.binU_U_51[i])
}
coverage_tauDPjags.binU_U_51
cover_tauDPjags.binU_U_51 <- round(mean(coverage_tauDPjags.binU_U_51)*100, 2)


######## AVERAGE BIAS OF base_tau2 ###########
bias_basetau2DPjags.binU_U_51 <- c()
for (i in 1:N.sim){
  bias_basetau2DPjags.binU_U_51[i] <- abs(RhatsDPU_U_51$base_tau2U_U_51[i]- tau2)
}
avg_bias_basetau2DPjags.binU_U_51 <- round(mean(bias_basetau2DPjags.binU_U_51),2)

######## MSE OF base_tau2 #############
MSE_DPjags.bin.basetau2U_U_51 <- c()
for (i in 1:N.sim){
  MSE_DPjags.bin.basetau2U_U_51[i] <- RMSE(estimate =RhatsDPU_U_51$base_tau2U_U_51[i],
                                           parameter = tau2,
                                           type = "RMSE",
                                           MSE = TRUE         
  )
...
avg_MSE_DPjags.bin.basetau2U_U_51 <- round(mean(MSE_DPjags.bin.basetau2U_U_51),4)

############ COVERAGE OF base_tau2 ##################
interval_contains_true_mean <- function(i) {
  ( tau2 >= RhatsDPU_U_51$LB_base_tau2U_U_51[i]) && ( tau2 <= RhatsDPU_U_51$UB_base_tau2U_U_51[i])
}
interval_contains_true_mean(i)

coverage_basetau2DPjags.binU_U_51 <- c()
for (i in 1:N.sim){
  if (interval_contains_true_mean(i) == TRUE){
    coverage_basetau2DPjags.binU_U_51[i] = 1
  }
  else  {
    coverage_basetau2DPjags.binU_U_51[i] = 0
  }
  print(coverage_basetau2DPjags.binU_U_51[i])
}
coverage_basetau2DPjags.binU_U_51
cover_basetau2DPjags.binU_U_51 <- round(mean(coverage_basetau2DPjags.binU_U_51)*100, 2)

######################## ABSOLUTE BIAS OF RELATIVE EFFECTS ##################
abs_bias_relDPU_U_51 <- list()
mean_abs_bias_relDPU_U_51 <- list()
for(i in 1:N.sim){
  for(j in 1:nrow(pDPU_U_51[[i]])){
    abs_bias_relDPU_U_51[[i]] <- round(abs(listaDPU_U_51[[i]]$`rel_effDPU_U_51[[i]]` - pDPU_U_51[[i]]$true_eff ),2)
    mean_abs_bias_relDPU_U_51[[i]] <- mean(abs_bias_relDPU_U_51[[i]])
  }
}
#mean_bias_relDP

################## mean bias of the mean biases of each data set for relative effects  ###################
mean_abs_bias_of_mean_abs_bias_relDPU_U_51 <- unlist(mean_abs_bias_relDPU_U_51)
mean_abs_bias_of_mean_abs_bias_relDPU_U_51  <- round(mean(mean_abs_bias_of_mean_abs_bias_relDPU_U_51),2)

######################## AVERAGE DIFFERENCES OF RELATIVE EFFECTS ##################
rel_bias_relDPU_U_51 <- list()
mean_rel_bias_relDPU_U_51 <- list()
for(i in 1:N.sim){
  for(j in 1:nrow(pDPU_U_51[[i]])){
    rel_bias_relDPU_U_51[[i]] <- round((listaDPU_U_51[[i]]$`rel_effDPU_U_51[[i]]` - pDPU_U_51[[i]]$true_eff ),2)
    mean_rel_bias_relDPU_U_51[[i]] <- mean(rel_bias_relDPU_U_51[[i]])
  }
}
#mean_bias_relDP

################## mean bias of the mean biases of each data set for relative effects  ###################
mean_rel_bias_of_mean_rel_bias_relDPU_U_51 <- unlist(mean_rel_bias_relDPU_U_51)
mean_rel_bias_of_mean_rel_bias_relDPU_U_51  <- round(mean(mean_rel_bias_of_mean_rel_bias_relDPU_U_51),2)

#####
########################### FOR THE OVERLAPPING ######################
dataDPU_U_51 <- list()
overlapDP1U_U_51 <- list()
overlapDPU_U_51 <- list()
for(i in 1:N.sim){
  dataDPU_U_51[[i]] <- list(DP = listaDPU_U_51[[i]]$`rel_effDPU_U_51[[i]]` , True = pDPU_U_51[[i]]$true_eff  )
  overlapDP1U_U_51[[i]] <- overlap(dataDPU_U_51[[i]], type = "2")
  overlapDPU_U_51[[i]] <- overlapDP1U_U_51[[i]]$OV
}
overlapDPU_U_51 <- unlist(overlapDPU_U_51)
avg_overlapDPU_U_51 <- round(mean(overlapDPU_U_51),2)


listaDP_rel_effU_U_51 <- cbind( mean_abs_bias_relDPU_U_51, mean_abs_bias_of_mean_abs_bias_relDPU_U_51,
                                mean_rel_bias_relDPU_U_51, mean_rel_bias_of_mean_rel_bias_relDPU_U_51) 

######### SAVE THE OUTPUTS ###########
DP_bin_jagsU_U_51 <- cbind(RhatsDPU_U_51,
                           abs_biasDPjags.binU_U_51, rel_biasDPjags.binU_U_51,
                           MSE_DPjags.binU_U_51, biasDPjags_basemu.binU_U_51, MSE_DPjags_basemu.binU_U_51,
                           bias_tau2DPjags.binU_U_51,rel_bias_tauDPjags.binU_U_51, abs_bias_tauDPjags.binU_U_51, 
                           MSE_DPjags.bin.tau2U_U_51, MSE_DPjags.bin.tauU_U_51,
                           bias_basetau2DPjags.binU_U_51, MSE_DPjags.bin.basetau2U_U_51, 
                           avg_abs_biasDPjags.binU_U_51, avg_rel_biasDPjags.binU_U_51, 
                           avg_biasDPjags_basemu.binU_U_51, 
                           avg_bias_tau2DPjags.binU_U_51,pbias_tau2DPjags.binU_U_51,avg_rel_bias_tauDPjags.binU_U_51,avg_abs_bias_tauDPjags.binU_U_51,
                           prel_bias_tauDPjags.binU_U_51,pabs_bias_tauDPjags.binU_U_51,
                           avg_bias_basetau2DPjags.binU_U_51,
                           rel_bias_tauDPjags.binU_U_51,abs_bias_tauDPjags.binU_U_51,
                           avg_MSE_DPjags.binU_U_51,avg_MSE_DPjags_basemu.binU_U_51,avg_MSE_DPjags.bin.tau2U_U_51, nMSE_DPjags.bin.tau2U_U_51,
                           avg_MSE_DPjags.bin.tauU_U_51, nMSE_DPjags.bin.tauU_U_51,
                           avg_MSE_DPjags.bin.basetau2U_U_51,
                           coverageDPjags.binU_U_51 , coverageDPjags_basemu.binU_U_51, coverage_tau2DPjags.binU_U_51, coverage_basetau2DPjags.binU_U_51, 
                           coverage_tauDPjags.binU_U_51, 
                           coverDPjags.binU_U_51, coverDPjags_basemu.binU_U_51, cover_tau2DPjags.binU_U_51, cover_tauDPjags.binU_U_51,
                           cover_basetau2DPjags.binU_U_51, RhatDP_outU_U_51)

Overlap_DPmodelU_U_51 <- cbind(overlapDPU_U_51, avg_overlapDPU_U_51)                    

write.csv(DP_bin_jagsU_U_51, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\DP MODEL\\rev_U_U51_ResultsDP_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
write.csv(listaDPU_U_51, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\DP MODEL\\rev_U_U51_Relative_eff_ResultsDP_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
write.csv(listaDP_rel_effU_U_51, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\DP MODEL\\rev_U_U51_Bias_Relative_eff_ResultsDP_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
write.csv(listaDP_weightsU_U_51, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\DP MODEL\\rev_U_U51_Weights_in_clusters_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=TRUE )  
write.csv(Overlap_DPmodelU_U_51, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\DP MODEL\\rev_U_U51Overlap_DPmodel_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=TRUE )  
...
write.csv(SNormal_HN, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\SKEW NORMAL MODEL\\rev_HN_ResultsSN_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
write.csv(deltaSN_HN, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\SKEW NORMAL MODEL\\rev_HN_Relative_eff_ResultsSN_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv" ) 
write.csv(listaSN_rel_eff_HN, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\SKEW NORMAL MODEL\\rev_HN_Bias_Relative_eff_ResultsSN_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv" ) 
write.csv(listaSN_HN, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\SKEW NORMAL MODEL\\rev_HN_Skew_ResultsSN_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv" ) 
write.csv(Overlap_SNmodel_HN, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\SKEW NORMAL MODEL\\rev_HN_Overlap_SNmodel_bin_data_k=26_mu=0.5_tau2=2.63.csv" ) 
...
write.csv(SNormal_U, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\SKEW NORMAL MODEL\\rev_U_ResultsSN_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
write.csv(deltaSN_U, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\SKEW NORMAL MODEL\\rev_U_Relative_eff_ResultsSN_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv" ) 
write.csv(listaSN_rel_eff_U, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\SKEW NORMAL MODEL\\rev_U_Bias_Relative_eff_ResultsSN_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv" ) 
write.csv(listaSN_U, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\SKEW NORMAL MODEL\\rev_U_Skew_ResultsSN_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv" ) 
write.csv(Overlap_SNmodel_U, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\SKEW NORMAL MODEL\\rev_U_Overlap_SNmodel_bin_data_k=26_mu=0.5_tau2=2.63.csv" ) 
...
write.csv(t_distr_HN, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\T MODEL\\rev_HN_Results_t_distr_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
write.csv(delta_tdistr_HN, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\T MODEL\\rev_HN_Relative_eff_Results_t_distr_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv" ) 
write.csv(listat_distr_rel_eff_HN, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\T MODEL\\rev_HN_Bias_Relative_eff_Results_t_distr_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv" ) 
write.csv(Overlap_tdistr_HN, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\T MODEL\\rev_HN_Overlap_tdistr_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv" ) 
# 
...
write.csv(t_distr_U, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\T MODEL\\rev_U_Results_t_distr_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
write.csv(delta_tdistr_U, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\T MODEL\\rev_U_Relative_eff_Results_t_distr_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv" ) 
write.csv(listat_distr_rel_eff_U, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\T MODEL\\rev_U_Bias_Relative_eff_Results_t_distr_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv" ) 
write.csv(Overlap_tdistr_U, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\T MODEL\\rev_U_Overlap_tdistr_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv" ) 
...
write.csv(fr_normal.bin, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\freq_normal.bin\\rev_Results_freq_N_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
...
write.csv(stud_eff , "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\freq_normal\\rev_Rel_eff_freq_N_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
...
write.csv(mean_abs_bias_of_mean_abs_bias_relnormfr_distr , "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\freq_normal\\rev_Mean_abs_bias_Rel_eff_freq_N_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  

# ######################## AAVERAGE DIFFERENCES OF RELATIVE EFFECTS ##################
...
write.csv(mean_rel_bias_of_mean_rel_bias_relnormfr_distr , "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\freq_normal\\rev_Mean_rel_bias_Rel_eff_freq_N_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
...
write.csv(overlap_normfr, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\freq_normal\\rev_Overlap_freq_N_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
...
write.csv(fr_normal, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\freq_normal\\rev_Results_freq_N_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
...
write.csv(metaplus_t, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\freq_tmodel\\rev_Results_metaplust_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
...
###############
##### PERCENT RELATIVE BIAS OF tau_common #########
...
write.csv(metaplus_mix, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\freq_mixture\\rev_Results_metaplusmix_jags_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv",row.names=FALSE )  
...
for(i in 1:r){
  for(j in 1:c){
    ...
    else{matrix[9,2] <- avg_abs_biasDPjags.binHN_U_26}
    
    if(RhatDP_outHN_U_51>0.05){
      matrix[10,2] <- "NON-CONVERGENCE"
    }
    else{matrix[10,2] <- avg_abs_biasDPjags.binHN_U_51}
    
    if(RhatDP_outU_U_26>0.05){
      matrix[11,2] <- "NON-CONVERGENCE"
    }
    else{matrix[11,2] <- avg_abs_biasDPjags.binU_U_26}
    ...
    else{matrix[13,2] <- avg_abs_biasDPjags.binU_U_51}
    ...
    else{matrix[9,3] <-  avg_MSE_DPjags.binHN_U_26}
    
    if(RhatDP_outHN_U_51>0.05){
      matrix[10,3] <- "NON-CONVERGENCE"
    }
    else{matrix[10,3] <- avg_MSE_DPjags.binHN_U_51}
    
    if(RhatDP_outU_U_26>0.05){
      matrix[11,3] <- "NON-CONVERGENCE"
    }
    else{matrix[11,3] <- avg_MSE_DPjags.binU_U_26}
    ...
    else{matrix[13,3] <- avg_MSE_DPjags.binU_U_51}
    ...
    else{matrix[9,4] <- avg_bias_tau2DPjags.binHN_U_26}
    
    if(RhatDP_outHN_U_51>0.05){
      matrix[10,4] <- "NON-CONVERGENCE"
    }
    else{matrix[10,4] <- avg_bias_tau2DPjags.binHN_U_51}
    
    if(RhatDP_outU_U_26>0.05){
      matrix[11,4] <- "NON-CONVERGENCE"
    }
    else{matrix[11,4] <- avg_bias_tau2DPjags.binU_U_26}
    ...
    else{matrix[13,4] <- avg_bias_tau2DPjags.binU_U_51}
    ...
    else{matrix[9,5] <- avg_MSE_DPjags.bin.tau2HN_U_26}
    
    if(RhatDP_outHN_U_51>0.05){
      matrix[10,5] <- "NON-CONVERGENCE"
    }
    else{matrix[10,5] <- avg_MSE_DPjags.bin.tau2HN_U_51}
    
    if(RhatDP_outU_U_26>0.05){
      matrix[11,5] <- "NON-CONVERGENCE"
    }
    else{matrix[11,5] <- avg_MSE_DPjags.bin.tau2U_U_26}
    ...
    else{matrix[13,5] <- avg_MSE_DPjags.bin.tau2U_U_51}
    ...
    else{matrix[9,6] <- coverDPjags.binHN_U_26}
    
    if(RhatDP_outHN_U_51>0.05){
      matrix[10,6] <- "NON-CONVERGENCE"
    }
    else{matrix[10,6] <- coverDPjags.binHN_U_51}
    
    if(RhatDP_outU_U_26>0.05){
      matrix[11,6] <- "NON-CONVERGENCE"
    }
    else{matrix[11,6] <- coverDPjags.binU_U_26}
    ...
    else{matrix[13,6] <- coverDPjags.binU_U_51}
    ...
    else{matrix[9,7] <- cover_tau2DPjags.binHN_U_26}
    
    if(RhatDP_outHN_U_51>0.05){
      matrix[10,7] <- "NON-CONVERGENCE"
    }
    else{matrix[10,7] <- cover_tau2DPjags.binHN_U_51}
    
    if(RhatDP_outU_U_26>0.05){
      matrix[11,7] <- "NON-CONVERGENCE"
    }
    else{matrix[11,7] <- cover_tau2DPjags.binU_U_26}
    ...
    else{matrix[13,7] <- cover_tau2DPjags.binU_U_51}
    ...
    else{matrix[9,8] <- pbias_tau2DPjags.binHN_U_26}
    
    if(RhatDP_outHN_U_51>0.05){
      matrix[10,8] <- "NON-CONVERGENCE"
    }
    else{matrix[10,8] <- pbias_tau2DPjags.binHN_U_51}
    
    if(RhatDP_outU_U_26>0.05){
      matrix[11,8] <- "NON-CONVERGENCE"
    }
    else{matrix[11,8] <- pbias_tau2DPjags.binU_U_26}
    ...
    else{matrix[13,8] <- pbias_tau2DPjags.binU_U_51}
    ...
    else{matrix[9,9] <- nMSE_DPjags.bin.tau2HN_U_26}
    
    if(RhatDP_outHN_U_51>0.05){
      matrix[10,9] <- "NON-CONVERGENCE"
    }
    else{matrix[10,9] <- nMSE_DPjags.bin.tau2HN_U_51}
    
    if(RhatDP_outU_U_26>0.05){
      matrix[11,9] <- "NON-CONVERGENCE"
    }
    else{matrix[11,9] <- nMSE_DPjags.bin.tau2U_U_26}
    ...
    else{matrix[13,9] <- nMSE_DPjags.bin.tau2U_U_51}
    ...
    else{matrix[9,10] <- avg_rel_bias_tauDPjags.binHN_U_26}
    
    if(RhatDP_outHN_U_51>0.05){
      matrix[10,10] <- "NON-CONVERGENCE"
    }
    else{matrix[10,10] <- avg_rel_bias_tauDPjags.binHN_U_51}
    
    if(RhatDP_outU_U_26>0.05){
      matrix[11,10] <- "NON-CONVERGENCE"
    }
    else{matrix[11,10] <- avg_rel_bias_tauDPjags.binU_U_26}
    ...
    else{matrix[13,10] <- avg_rel_bias_tauDPjags.binU_U_51}
    ...
    else{matrix[9,11] <- avg_MSE_DPjags.bin.tauHN_U_26}
    
    if(RhatDP_outHN_U_51>0.05){
      matrix[10,11] <- "NON-CONVERGENCE"
    }
    else{matrix[10,11] <- avg_MSE_DPjags.bin.tauHN_U_51}
    
    if(RhatDP_outU_U_26>0.05){
      matrix[11,11] <- "NON-CONVERGENCE"
    }
    else{matrix[11,11] <- avg_MSE_DPjags.bin.tauU_U_26}
    ...
    else{matrix[13,11] <- avg_MSE_DPjags.bin.tauU_U_51}
    ...
    else{matrix[9,12] <- cover_tauDPjags.binHN_U_26}
    
    if(RhatDP_outHN_U_51>0.05){
      matrix[10,12] <- "NON-CONVERGENCE"
    }
    else{matrix[10,12] <- cover_tauDPjags.binHN_U_51}
    
    if(RhatDP_outU_U_26>0.05){
      matrix[11,12] <- "NON-CONVERGENCE"
    }
    else{matrix[11,12] <- cover_tauDPjags.binU_U_26}
    ...
    else{matrix[13,12] <- cover_tauDPjags.binU_U_51}
    ...
    else{matrix[9,13] <- prel_bias_tauDPjags.binHN_U_26}
    
    if(RhatDP_outHN_U_51>0.05){
      matrix[10,13] <- "NON-CONVERGENCE"
    }
    else{matrix[10,13] <- prel_bias_tauDPjags.binHN_U_51}
    
    if(RhatDP_outU_U_26>0.05){
      matrix[11,13] <- "NON-CONVERGENCE"
    }
    else{matrix[11,13] <- prel_bias_tauDPjags.binU_U_26}
    ...
    else{matrix[13,13] <- prel_bias_tauDPjags.binU_U_51}
    ...
    else{matrix[9,14] <- nMSE_DPjags.bin.tauHN_U_26}
    
    if(RhatDP_outHN_U_51>0.05){
      matrix[10,14] <- "NON-CONVERGENCE"
    }
    else{matrix[10,14] <- nMSE_DPjags.bin.tauHN_U_51}
    
    if(RhatDP_outU_U_26>0.05){
      matrix[11,14] <- "NON-CONVERGENCE"
    }
    else{matrix[11,14] <- nMSE_DPjags.bin.tauU_U_26}
    ...
    else{matrix[13,14] <- nMSE_DPjags.bin.tauU_U_51}
    ...
    else{matrix[9,15] <- avg_abs_bias_tauDPjags.binHN_U_26}
    
    if(RhatDP_outHN_U_51>0.05){
      matrix[10,15] <- "NON-CONVERGENCE"
    }
    else{matrix[10,15] <- avg_abs_bias_tauDPjags.binHN_U_51}
    
    if(RhatDP_outU_U_26>0.05){
      matrix[11,15] <- "NON-CONVERGENCE"
    }
    else{matrix[11,15] <- avg_abs_bias_tauDPjags.binU_U_26}
    ...
    else{matrix[13,15] <- avg_abs_bias_tauDPjags.binU_U_51}
    ...
    else{matrix[9,16] <- pabs_bias_tauDPjags.binHN_U_26}
    
    if(RhatDP_outHN_U_51>0.05){
      matrix[10,16] <- "NON-CONVERGENCE"
    }
    else{matrix[10,16] <- pabs_bias_tauDPjags.binHN_U_51}
    
    if(RhatDP_outU_U_26>0.05){
      matrix[11,16] <- "NON-CONVERGENCE"
    }
    else{matrix[11,16] <- pabs_bias_tauDPjags.binU_U_26}
    ...
    else{matrix[13,16] <- pabs_bias_tauDPjags.binU_U_51}
    ...
    else{matrix[9,17] <- avg_rel_biasDPjags.binHN_U_26}
    
    if(RhatDP_outHN_U_51>0.05){
      matrix[10,17] <- "NON-CONVERGENCE"
    }
    else{matrix[10,17] <- avg_rel_biasDPjags.binHN_U_51}
    
    if(RhatDP_outU_U_26>0.05){
      matrix[11,17] <- "NON-CONVERGENCE"
    }
    else{matrix[11,17] <- avg_rel_biasDPjags.binU_U_26}
    ...
    else{matrix[13,17] <- avg_rel_biasDPjags.binU_U_51}
...
write.csv(matrix, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\ALL MODELS\\rev_Matrix_All_models_Normal_bin_data_k=26_mu=0.5_tau2=2.63.csv" ) 
...
for(i in 1:r){
  for(j in 1:c){
    ...
    else{matrix1[7,2] <- mean_abs_bias_of_mean_abs_bias_relDPHN_U_26}
    
    if(RhatDP_outHN_U_51>0.05){
      matrix1[8,2] <- "NON-CONVERGENCE"
    }
    else{matrix1[8,2] <- mean_abs_bias_of_mean_abs_bias_relDPHN_U_51}
    
    if(RhatDP_outU_U_26>0.05){
      matrix1[9,2] <- "NON-CONVERGENCE"
    }
    else{matrix1[9,2] <- mean_abs_bias_of_mean_abs_bias_relDPU_U_26}
    ...
    else{matrix1[11,2] <- mean_abs_bias_of_mean_abs_bias_relDPU_U_51}
    ...
    else{matrix1[7,3] <- mean_rel_bias_of_mean_rel_bias_relDPHN_U_26}
    
    if(RhatDP_outHN_U_51>0.05){
      matrix1[8,3] <- "NON-CONVERGENCE"
    }
    else{matrix1[8,3] <- mean_rel_bias_of_mean_rel_bias_relDPHN_U_51}
    
    if(RhatDP_outU_U_26>0.05){
      matrix1[9,3] <- "NON-CONVERGENCE"
    }
    else{matrix1[9,3] <- mean_rel_bias_of_mean_rel_bias_relDPU_U_26}
    ...
    else{matrix1[11,3] <- mean_rel_bias_of_mean_rel_bias_relDPU_U_51}
...
write.csv(matrix1, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\ALL MODELS\\rev_Matrix_Bias_Rel_eff_Normal_data_k=26_mu=0.5_tau2=2.63.csv" ) 

################### summary of the results #####################
r = 8
c = 3
matrix2 = matrix(nrow = r, ncol = c)
...
for(i in 1:r){
  for(j in 1:c){
    ...
    matrix2[1,2] <- "precision_mu" 
    
    matrix2[1,3] <- "precision_pred" 
    
    matrix2[2,1] <- "Binomial-Normal(HN)"
    matrix2[3,1] <- "Binomial-Normal(Unif)"
    matrix2[4,1] <- "Normal-Normal"
    matrix2[5,1] <- "Binomial-t(HN)"
    matrix2[6,1] <- "Binomial-t(Unif)"
    matrix2[7,1] <- "Binomial-SN(HN)"
    matrix2[8,1] <- "Binomial-SN(Unif)"
    
    ######### precision of mu
    matrix2[2,2] <- len_mu_NHN 
    matrix2[3,2] <- len_mu_NU 
    matrix2[4,2] <- len_mu_frnormal
    matrix2[5,2] <- len_mu_t_distr_HN
    matrix2[6,2] <- len_mu_t_distr_U
    matrix2[7,2] <- len_mu_SN_HN
    matrix2[8,2] <- len_mu_SN_U
    ######### precision of pred 
    matrix2[2,3] <- len_PI_NHN 
    matrix2[3,3] <- len_PI_NU 
    matrix2[4,3] <- len_PI_frnormal
    matrix2[5,3] <- len_PI_t_distr_HN
    matrix2[6,3] <- len_PI_t_distr_U
    matrix2[7,3] <- len_PI_SN_HN
    matrix2[8,3] <- len_PI_SN_U
  }
}

write.csv(matrix2, "C:\\Users\\Lela Panag\\Desktop\\SIMULATION SCENARIOS FINAL\\NORMAL DATA\\ALL MODELS\\Matrix_prec_Normal_data_k=26_mu=0.5_tau2=2.63.csv" ) 
